...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/TaimoorSiddiquiOfficial/hopcoderx/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for TaimoorSiddiquiOfficial/hopcoderx...\n")
...
console.log("Fetching npm all-time downloads for HopCoderX-ai...\n")
const npmDownloads = await fetchNpmDownloads("HopCoderX-ai")
