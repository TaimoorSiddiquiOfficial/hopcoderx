...
# Package manager
npm i -g HopCoderX-ai@latest        # oppure bun/pnpm/yarn
scoop install HopCoderX             # Windows
choco install HopCoderX             # Windows
brew install TaimoorSiddiquiOfficial/tap/hopcoderx # macOS e Linux (consigliato, sempre aggiornato)
brew install HopCoderX              # macOS e Linux (formula brew ufficiale, aggiornata meno spesso)
sudo pacman -S HopCoderX            # Arch Linux (Stable)
paru -S HopCoderX-bin               # Arch Linux (Latest from AUR)
mise use -g HopCoderX               # Qualsiasi OS
nix run nixpkgs#HopCoderX           # oppure github:TaimoorSiddiquiOfficial/hopcoderx per l’ultima branch di sviluppo
```
...
HopCoderX è disponibile anche come applicazione desktop. Puoi scaricarla direttamente dalla [pagina delle release](https://github.com/TaimoorSiddiquiOfficial/hopcoderx/releases) oppure da [HopCoderX.ai/download](https://HopCoderX.ai/download).
...
1. `$HOPCODERX_INSTALL_DIR` – Directory di installazione personalizzata
2. `$XDG_BIN_DIR` – Percorso conforme alla XDG Base Directory Specification
3. `$HOME/bin` – Directory binaria standard dell’utente (se esiste o può essere creata)
4. `$HOME/.HopCoderX/bin` – Fallback predefinito
...
HopCoderX include due agenti integrati tra cui puoi passare usando il tasto `Tab`.
...
Scopri di più sugli [agenti](https://HopCoderX.ai/docs/agents).

### Documentazione

Per maggiori informazioni su come configurare HopCoderX, [**consulta la nostra documentazione**](https://HopCoderX.ai/docs).

### Contribuire

Se sei interessato a contribuire a HopCoderX, leggi la nostra [guida alla contribuzione](./CONTRIBUTING.md) prima di inviare una pull request.

### Costruire su HopCoderX

Se stai lavorando a un progetto correlato a HopCoderX e che utilizza “HopCoderX” come parte del nome (ad esempio “HopCoderX-dashboard” o “HopCoderX-mobile”), aggiungi una nota nel tuo README per chiarire che non è sviluppato dal team HopCoderX e che non è affiliato in alcun modo con noi.
...
**Unisciti alla nostra community** [Discord](https://discord.gg/HopCoderX) | [X.com](https://x.com/HopCoderX)
