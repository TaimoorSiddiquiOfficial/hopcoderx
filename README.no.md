...
HopCoderX er også tilgjengelig som en desktop-app. Last ned direkte fra [releases-siden](https://github.com/TaimoorSiddiquiOfficial/hopcoderx/releases) eller [HopCoderX.ai/download](https://HopCoderX.ai/download).
...
Les mer om [agents](https://HopCoderX.ai/docs/agents).

### Dokumentasjon

For mer info om hvordan du konfigurerer HopCoderX, [**se dokumentasjonen**](https://HopCoderX.ai/docs).
...
- 100% open source
- Ikke knyttet til en bestemt leverandør. Selv om vi anbefaler modellene vi tilbyr gjennom [HopCoderX Zen](https://HopCoderX.ai/zen); kan HopCoderX brukes med Claude, OpenAI, Google eller til og med lokale modeller. Etter hvert som modellene utvikler seg vil gapene lukkes og prisene gå ned, så det er viktig å være provider-agnostic.
