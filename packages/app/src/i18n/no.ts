...
export const dict = {
  ...
  "dialog.provider.HopCoderX.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av HopCoderX",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i HopCoderX.",
  ...
  "provider.connect.HopCoderXZen.line1":
    "HopCoderX Bdr gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.HopCoderXZen.visit.prefix": "Besøk ",
  "provider.connect.HopCoderXZen.visit.link": "HopCoderX.ai/zen",
  "provider.connect.HopCoderXZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i HopCoderX.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i HopCoderX.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i HopCoderX.json",
  ...
  "dialog.server.description": "Bytt hvilken HopCoderX-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av HopCoderX ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til HopCoderX-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (HopCoderX.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at HopCoderX ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "HopCoderX inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør HopCoderX-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for HopCoderX",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan HopCoderX ser ut på enheten din",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan HopCoderX er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når HopCoderX starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av HopCoderX.",
