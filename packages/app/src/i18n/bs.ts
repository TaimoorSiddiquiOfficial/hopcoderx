export const dict = {
  ...
  "dialog.provider.HopCoderX.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje HopCoderX",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u HopCoderX-u.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u HopCoderX-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u HopCoderX-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u HopCoderX.json",
  ...
  "dialog.server.description": "Promijeni na koji se HopCoderX server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija HopCoderX-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku HopCoderX timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (HopCoderX.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: HopCoderX još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "HopCoderX uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni HopCoderX server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u HopCoderX-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako HopCoderX izgleda na tvom uređaju",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu HopCoderX-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se HopCoderX pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju HopCoderX-a.",
