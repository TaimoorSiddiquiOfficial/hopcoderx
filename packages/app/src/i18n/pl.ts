export const dict = {
  ...
  "dialog.provider.HopCoderX.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez HopCoderX",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w HopCoderX.",
  ...
  "provider.connect.HopCoderXZen.line1":
    "HopCoderX Bdr daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.HopCoderXZen.visit.prefix": "Odwiedź ",
  "provider.connect.HopCoderXZen.visit.link": "hopcoderx.dev/bdr",
  "provider.connect.HopCoderXZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w HopCoderX.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w HopCoderX.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w HopCoderX.json",
  ...
  "dialog.server.description": "Przełącz serwer HopCoderX, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja HopCoderX ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu HopCoderX",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (HopCoderX.json) nazwy dostawców/modeli",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, HopCoderX does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "HopCoderX zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Run the HopCoderX server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla HopCoderX",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd HopCoderX na swoim urządzeniu",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw HopCoderX.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania HopCoderX",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji HopCoderX.",
