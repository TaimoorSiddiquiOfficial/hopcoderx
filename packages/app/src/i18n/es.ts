export const dict = {
  ...
  "dialog.provider.HopCoderX.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por HopCoderX",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en HopCoderX.",
  ...
  "provider.connect.HopCoderXZen.line1":
    "HopCoderX Bdr te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  "provider.connect.HopCoderXZen.line2":
    "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.HopCoderXZen.visit.prefix": "Visita ",
  "provider.connect.HopCoderXZen.visit.link": "HopCoderX.ai/zen",
  "provider.connect.HopCoderXZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en HopCoderX.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en HopCoderX.",
  ...
  "dialog.plugins.empty": "Plugins configurados en HopCoderX.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de HopCoderX se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de HopCoderX ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de HopCoderX",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (HopCoderX.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, HopCoderX no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "HopCoderX incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor HopCoderX dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para HopCoderX",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve HopCoderX en tu dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de HopCoderX.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia HopCoderX",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de HopCoderX.",
