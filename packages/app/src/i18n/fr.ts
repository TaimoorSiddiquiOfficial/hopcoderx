export const dict = {
  ...
  "dialog.provider.HopCoderX.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par HopCoderX",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans HopCoderX.",
  ...
  "provider.connect.HopCoderXZen.line1":
    "HopCoderX Bdr vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.HopCoderXZen.visit.prefix": "Visitez ",
  "provider.connect.HopCoderXZen.visit.link": "hopcoderx.dev/zen",
  "provider.connect.HopCoderXZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans HopCoderX.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans HopCoderX.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans HopCoderX.json",
  ...
  "dialog.server.description": "Changez le serveur HopCoderX auquel cette application se connecte.",
  ...
  "toast.update.description":
    "Une nouvelle version d'HopCoderX ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe HopCoderX",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (HopCoderX.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'HopCoderX ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "HopCoderX inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "app.name.desktop": "HopCoderX Desktop",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur HopCoderX dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour HopCoderX",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'HopCoderX sur votre appareil",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'HopCoderX.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'HopCoderX",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'HopCoderX.",
