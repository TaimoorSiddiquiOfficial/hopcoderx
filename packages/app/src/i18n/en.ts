export const dict = {
  ...
  "dialog.provider.HopCoderX.note": "Curated models including Claude, GPT, Gemini and more",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by HopCoderX",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in HopCoderX.",
  ...
  "provider.connect.HopCoderXZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in HopCoderX.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in HopCoderX.",
  ...
  "dialog.plugins.empty": "Plugins configured in HopCoderX.json",
  ...
  "dialog.server.description": "Switch which HopCoderX server this app connects to.",
  ...
  "toast.update.description": "A new version of HopCoderX ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the HopCoderX team",
  ...
  "error.chain.checkConfig": "Check your config (HopCoderX.json) provider/model names",
  ...
  "sidebar.gettingStarted.line1": "HopCoderX includes free models so you can start immediately.",
  ...
  "settings.general.row.language.description": "Change the display language for HopCoderX",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how HopCoderX looks on your device",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how HopCoderX is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when HopCoderX launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of HopCoderX.",
