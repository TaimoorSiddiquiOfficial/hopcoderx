...
export const dict = {
  ...
  "dialog.provider.HopCoderX.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von HopCoderX",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in HopCoderX zu nutzen.",
  ...
  "provider.connect.HopCoderXZen.line1":
    "HopCoderX Bdr bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in HopCoderX zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in HopCoderX zu nutzen.",
  ...
  "dialog.plugins.empty": "In HopCoderX.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den HopCoderX-Server, mit dem sich diese App verbindet.",
  ...
  "toast.update.description": "Eine neue Version von HopCoderX ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem HopCoderX-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (HopCoderX.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: HopCoderX unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "HopCoderX enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "HopCoderX-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für HopCoderX ändern",
  "settings.general.row.appearance.title": "Erscheinungsbild",
  "settings.general.row.appearance.description": "Anpassen, wie HopCoderX auf Ihrem Gerät aussieht",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von HopCoderX anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von HopCoderX automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von HopCoderX.",
