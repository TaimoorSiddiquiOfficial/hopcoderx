...
beforeAll(async () => {
  ...
  mock.module("@hopcoderx/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@hopcoderx/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@hopcoderx/ui/icon", () => ({ Icon: () => null }))
  mock.module("@hopcoderx/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
