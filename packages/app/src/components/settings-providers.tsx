...
import { iconNames, type IconName } from "@hopcoderx/ui/icons/provider"
...
const PROVIDER_NOTES = [
  { match: (id: string) => id === "hopcoderx", key: "dialog.provider.HopCoderX.note" },
...
export const SettingsProviders: Component = () => {
  ...
  const connected = createMemo(() => {
    return providers
      .connected()
      .filter((p) => p.id !== "hopcoderx" || Object.values(p.models).find((m) => m.cost?.input))
  })
