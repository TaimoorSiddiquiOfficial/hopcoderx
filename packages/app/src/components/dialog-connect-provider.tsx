import type { ProviderAuthAuthorization } from "@hopcoderx/sdk/v2/client"
...
import { List, type ListRef } from "@hopcoderx/ui/list"
import { ProviderIcon } from "@hopcoderx/ui/provider-icon"
import { Spinner } from "@hopcoderx/ui/spinner"
  ...
  function ApiAuthView() {
    ...
    return (
      <div class="flex flex-col gap-6">
        <Switch>
          <Match when={provider().id === "HopCoderX"}>
            <div class="flex flex-col gap-4">
              <div class="text-14-regular text-text-base">{language.t("provider.connect.HopCoderXZen.line1")}</div>
              ...
              <div class="text-14-regular text-text-base">
                ...
                <Link href="https://HopCoderX.ai/zen" tabIndex={-1}>
