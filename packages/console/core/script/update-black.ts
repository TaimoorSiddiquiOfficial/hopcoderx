...
const oldValue = lines.find((line) => line.startsWith("BDR_BLACK_LIMITS"))?.split("=")[1] ?? "{}"
if (!oldValue) throw new Error("BDR_BLACK_LIMITS not found")
...
// update the secret
await $`bun sst secret set BDR_BLACK_LIMITS ${newValue}`
