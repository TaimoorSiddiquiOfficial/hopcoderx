...
export const dict = {
  ...
  "notFound.title": "غير موجود | HopCoderX",
  ...
  "home.title": "HopCoderX | وكيل برمجة بالذكاء الاصطناعي مفتوح المصدر",
  ...
  "temp.screenshot.alt": "واجهة HopCoderX الطرفية بسمة tokyonight",
  ...
  "home.what.title": "ما هو HopCoderX؟",
  "home.what.body": "HopCoderX وكيل مفتوح المصدر يساعدك على كتابة الكود في الطرفية، IDE، أو سطح المكتب.",
  ...
  "home.growth.body":
    "مع أكثر من <strong>{{stars}}</strong> نجمة على GitHub، و<strong>{{contributors}}</strong> مساهمًا، وأكثر من <strong>{{commits}}</strong> Commit، يستخدم HopCoderX ويثق به أكثر من <strong>{{monthlyUsers}}</strong> مطوّر كل شهر.",
  ...
  "home.privacy.body": "لا يخزّن HopCoderX أي كود أو بيانات سياق، ليتمكن من العمل في بيئات حساسة للخصوصية.",
  "home.privacy.learnMore": "اعرف المزيد عن",
  "home.privacy.link": "الخصوصية",

  "home.faq.q1": "ما هو HopCoderX؟",
  "home.faq.a1":
    "HopCoderX وكيل مفتوح المصدر يساعدك على كتابة وتشغيل الكود مع أي نموذج ذكاء اصطناعي. متاح كواجهة طرفية، وتطبيق سطح مكتب، أو امتداد IDE.",
  "home.faq.q2": "كيف أستخدم HopCoderX؟",
  ...
  "home.faq.a4.p1":
    "نعم، يدعم HopCoderX خطط الاشتراك من كل المزودين الرئيسيين. يمكنك استخدام اشتراكات Claude Pro/Max، ChatGPT Plus/Pro، أو GitHub Copilot.",
  "home.faq.q5": "هل يمكنني استخدام HopCoderX في الطرفية فقط؟",
  "home.faq.a5.beforeDesktop": "ليس بعد الآن! HopCoderX متاح الآن كتطبيق لـ",
  "home.faq.a5.desktop": "سطح المكتب",
  "home.faq.a5.and": "و",
  "home.faq.a5.web": "الويب",
  "home.faq.q6": "كم تكلفة HopCoderX؟",
  "home.faq.a6":
    "HopCoderX مجاني 100% للاستخدام. كما يأتي مع مجموعة من النماذج المجانية. قد توجد تكاليف إضافية إذا ربطت مزوّدًا آخر.",
  ...
  "home.faq.q8": "هل HopCoderX مفتوح المصدر؟",
  "home.faq.a8.p1": "نعم، HopCoderX مفتوح المصدر بالكامل. الكود المصدري متاح علنًا على",
  ...
  "black.title": "HopCoderX Black | الأسعار",
  ...
  "black.workspace.title": "HopCoderX Black | اختر مساحة العمل",
  "black.workspace.selectPlan": "اختر مساحة عمل لهذه الخطة",
  "black.workspace.name": "مساحة العمل {{n}}",
  "black.subscribe.title": "اشترك في HopCoderX Black",
  ...
  "black.subscribe.success.title": "أنت في قائمة انتظار HopCoderX Black",
  ...
  "workspace.newUser.step.login.after": "واختر HopCoderX",
  "workspace.newUser.step.pasteKey": "الصق مفتاح API الخاص بك",
  "workspace.newUser.step.models.before": "ابدأ HopCoderX ثم نفّذ",
  ...
  "workspace.keys.subtitle": "إدارة مفاتيح API الخاصة بك للوصول إلى خدمات HopCoderX.",
  "workspace.keys.create": "إنشاء مفتاح API",
  "workspace.keys.placeholder": "أدخل اسم المفتاح",
  "workspace.keys.empty": "أنشئ مفتاح API لبوابة HopCoderX",
  ...
  "workspace.black.subscription.message": "أنت مشترك في HopCoderX Black مقابل ${{plan}} شهريًا.",
  ...
  "workspace.black.waitlist.joined": "أنت في قائمة الانتظار لخطة HopCoderX Black بقيمة ${{plan}} شهريًا.",
  "workspace.black.waitlist.ready": "نحن مستعدون لتسجيلك في خطة HopCoderX Black بقيمة ${{plan}} شهريًا.",
  ...
  "download.title": "HopCoderX | تنزيل",
  "download.meta.description": "نزّل HopCoderX لـ macOS، Windows، وLinux",
  "download.hero.title": "تنزيل HopCoderX",
  "download.hero.subtitle": "متاح في نسخة تجريبية لـ macOS، Windows، وLinux",
  "download.hero.button": "تنزيل لـ {{os}}",
  "download.section.terminal": "HopCoderX للطرفية",
  "download.section.desktop": "HopCoderX لسطح المكتب (Beta)",
  "download.section.extensions": "امتدادات HopCoderX",
  "download.section.integrations": "تكاملات HopCoderX",
  ...
  "enterprise.title": "HopCoderX | حلول المؤسسات لمنظمتك",
  "enterprise.meta.description": "تواصل مع HopCoderX لحلول المؤسسات",
  "enterprise.hero.title": "كودك ملكك",
  "enterprise.hero.body1":
    "يعمل HopCoderX بأمان داخل مؤسستك دون تخزين أي بيانات أو سياق، ودون قيود ترخيص أو مطالبات ملكية. ابدأ تجربة مع فريقك، ثم انشره عبر مؤسستك من خلال دمجه مع SSO وبوابة الذكاء الاصطناعي الداخلية لديك.",
  ...
  "enterprise.faq.q1": "ما هو HopCoderX Enterprise؟",
  "enterprise.faq.a1":
    "HopCoderX Enterprise مخصص للمؤسسات التي تريد التأكد من أن الكود والبيانات لا تغادر بنيتها التحتية أبدًا. يتحقق ذلك عبر استخدام تكوين مركزي يندمج مع SSO وبوابة الذكاء الاصطناعي الداخلية لديك.",
  "enterprise.faq.q2": "كيف أبدأ مع HopCoderX Enterprise؟",
  "enterprise.faq.a2":
    "ابدأ ببساطة بتجربة داخلية مع فريقك. افتراضيًا، لا يقوم HopCoderX بتخزين الكود أو بيانات السياق، مما يجعل البدء سهلاً. ثم اتصل بنا لمناقشة الأسعار وخيارات التنفيذ.",
  ...
  "enterprise.faq.q4": "هل بياناتي آمنة مع HopCoderX Enterprise؟",
  "enterprise.faq.a4":
    "نعم. لا يقوم HopCoderX بتخزين الكود أو بيانات السياق. تتم جميع المعالجة محليًا أو عبر استدعاءات API مباشرة إلى مزود الذكاء الاصطناعي لديك. مع التكوين المركزي وتكامل SSO، تظل بياناتك آمنة داخل البنية التحتية لمؤسستك.",

  "brand.title": "HopCoderX | العلامة التجارية",
  "brand.meta.description": "إرشادات العلامة التجارية لـ HopCoderX",
  "brand.heading": "إرشادات العلامة التجارية",
  "brand.subtitle": "موارد وأصول لمساعدتك في العمل مع العلامة التجارية لـ HopCoderX.",
  "brand.downloadAll": "تنزيل جميع الأصول",

  "changelog.title": "HopCoderX | سجل التغييرات",
  "changelog.meta.description": "ملاحظات الإصدار وسجل التغييرات لـ HopCoderX",
  "changelog.hero.title": "سجل التغييرات",
  "changelog.hero.subtitle": "تحديثات وتحسينات جديدة لـ HopCoderX",
