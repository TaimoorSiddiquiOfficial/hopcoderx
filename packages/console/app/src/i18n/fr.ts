...
export const dict = {
  ...
  "notFound.title": "Introuvable | HopCoderX",
  ...
  "home.title": "HopCoderX | L'agent de code IA open source",
  ...
  "temp.screenshot.alt": "HopCoderX TUI avec le thème tokyonight",
  ...
  "home.what.title": "Qu'est-ce que HopCoderX ?",
  "home.what.body":
    "HopCoderX est un agent open source qui vous aide à écrire du code dans votre terminal, IDE ou desktop.",
  ...
  "home.growth.body":
    "Avec plus de <strong>{{stars}}</strong> étoiles sur GitHub, <strong>{{contributors}}</strong> contributeurs et plus de <strong>{{commits}}</strong> commits, HopCoderX est utilisé et approuvé par plus de <strong>{{monthlyUsers}}</strong> développeurs chaque mois.",
  ...
  "home.privacy.body":
    "HopCoderX ne stocke ni votre code ni vos données de contexte, afin de pouvoir fonctionner dans des environnements sensibles à la confidentialité.",
  "home.privacy.learnMore": "En savoir plus sur",
  "home.privacy.link": "la confidentialité",

  "home.faq.q1": "Qu'est-ce que HopCoderX ?",
  "home.faq.a1":
    "HopCoderX est un agent open source qui vous aide à écrire et exécuter du code avec n'importe quel modèle d'IA. Il est disponible en interface terminal, application desktop ou extension IDE.",
  "home.faq.q2": "Comment utiliser HopCoderX ?",
  ...
  "home.faq.a4.p1":
    "Oui, HopCoderX prend en charge les abonnements des principaux fournisseurs. Vous pouvez utiliser Claude Pro/Max, ChatGPT Plus/Pro ou GitHub Copilot.",
  "home.faq.q5": "Puis-je utiliser HopCoderX uniquement dans le terminal ?",
  "home.faq.a5.beforeDesktop": "Plus maintenant ! HopCoderX est désormais disponible en application pour",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "et",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Combien coûte HopCoderX ?",
  "home.faq.a6":
    "HopCoderX est 100% gratuit. Il inclut aussi des modèles gratuits. Des coûts supplémentaires peuvent s'appliquer si vous connectez un autre fournisseur.",
  ...
  "home.faq.q8": "HopCoderX est-il open source ?",
  "home.faq.a8.p1": "Oui, HopCoderX est entièrement open source. Le code source est public sur",
  ...
  "black.title": "HopCoderX Black | Tarification",
  ...
  "black.workspace.title": "HopCoderX Black | Sélectionner un espace de travail",
  "black.workspace.selectPlan": "Sélectionnez un espace de travail pour ce forfait",
  "black.workspace.name": "Espace de travail {{n}}",
  "black.subscribe.title": "S'abonner à HopCoderX Black",
  ...
  "black.subscribe.success.title": "Vous êtes sur la liste d'attente HopCoderX Black",
  ...
  "workspace.newUser.step.login.after": "et sélectionnez HopCoderX",
  "workspace.newUser.step.pasteKey": "Collez votre clé API",
  "workspace.newUser.step.models.before": "Démarrez HopCoderX et exécutez",
  ...
  "workspace.keys.subtitle": "Gérez vos clés API pour accéder aux services HopCoderX.",
  "workspace.keys.create": "Créer une clé API",
  "workspace.keys.placeholder": "Entrez le nom de la clé",
  "workspace.keys.empty": "Créer une clé API HopCoderX Gateway",
  ...
  "workspace.black.subscription.message": "Vous êtes abonné à HopCoderX Black pour {{plan}} $ par mois.",
  ...
  "workspace.black.waitlist.joined":
    "Vous êtes sur la liste d'attente pour le forfait HopCoderX Black à {{plan}} $ par mois.",
  "workspace.black.waitlist.ready":
    "Nous sommes prêts à vous inscrire au forfait HopCoderX Black à {{plan}} $ par mois.",
  ...
  "download.title": "HopCoderX | Téléchargement",
  "download.meta.description": "Téléchargez HopCoderX pour macOS, Windows et Linux",
  "download.hero.title": "Télécharger HopCoderX",
  ...
  "download.section.desktop": "HopCoderX Desktop (Bêta)",
  "download.section.extensions": "Extensions HopCoderX",
  "download.section.integrations": "Intégrations HopCoderX",
  ...
  "enterprise.title": "HopCoderX | Solutions entreprise pour votre organisation",
  "enterprise.meta.description": "Contactez HopCoderX pour des solutions entreprise",
  "enterprise.hero.title": "Votre code vous appartient",
  "enterprise.hero.body1":
    "HopCoderX fonctionne de manière sécurisée au sein de votre organisation, sans stocker de données ni de contexte, et sans restrictions de licence ni revendications de propriété. Démarrez un essai avec votre équipe, puis déployez-le dans votre organisation en l'intégrant à votre SSO et à votre passerelle IA interne.",
  ...
  "enterprise.faq.q1": "Qu'est-ce que HopCoderX Enterprise ?",
  "enterprise.faq.a1":
    "HopCoderX Enterprise s'adresse aux organisations qui veulent s'assurer que leur code et leurs données ne quittent jamais leur infrastructure. Cela est possible grâce à une configuration centralisée qui s'intègre à votre SSO et à votre passerelle IA interne.",
  "enterprise.faq.q2": "Comment démarrer avec HopCoderX Enterprise ?",
  "enterprise.faq.a2":
    "Commencez simplement par un essai interne avec votre équipe. Par défaut, HopCoderX ne stocke pas votre code ni vos données de contexte, ce qui facilite la prise en main. Ensuite, contactez-nous pour discuter des tarifs et des options de mise en œuvre.",
  ...
  "enterprise.faq.q4": "Mes données sont-elles sécurisées avec HopCoderX Enterprise ?",
  "enterprise.faq.a4":
    "Oui. HopCoderX ne stocke pas votre code ni vos données de contexte. Tout le traitement se fait localement ou via des appels API directs vers votre fournisseur d'IA. Avec une configuration centralisée et une intégration SSO, vos données restent sécurisées au sein de l'infrastructure de votre organisation.",

  "brand.title": "HopCoderX | Marque",
  "brand.meta.description": "Guide de marque HopCoderX",
  "brand.heading": "Guide de marque",
  "brand.subtitle": "Ressources et éléments pour vous aider à travailler avec la marque HopCoderX.",
  "brand.downloadAll": "Télécharger tous les assets",

  "changelog.title": "HopCoderX | Changelog",
  "changelog.meta.description": "Notes de version et changelog d'HopCoderX",
  "changelog.hero.title": "Changelog",
  "changelog.hero.subtitle": "Nouvelles mises à jour et améliorations pour HopCoderX",
