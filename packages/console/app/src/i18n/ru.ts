...
export const dict = {
  ...
  "notFound.title": "Не найдено | HopCoderX",
  ...
  "home.title": "HopCoderX | AI-агент с открытым кодом для программирования",

  "temp.title": "HopCoderX | AI-агент для программирования в терминале",
  ...
  "temp.feature.bdr.beforeLink": "",
  "temp.feature.bdr.link": "Отобранный список моделей",
  "temp.feature.bdr.afterLink": "от HopCoderX",
  ...
  "temp.screenshot.caption": "HopCoderX TUI с темой tokyonight",
  "temp.screenshot.alt": "HopCoderX TUI с темой tokyonight",
  ...
  "home.what.title": "Что такое HopCoderX?",
  "home.what.body":
    "HopCoderX — это агент с открытым исходным кодом, который помогает писать код в терминале, IDE или на десктопе.",
  ...
  "home.growth.body":
    "С более чем <strong>{{stars}}</strong> звезд на GitHub, <strong>{{contributors}}</strong> контрибьюторов и <strong>{{commits}}</strong> коммитов, HopCoderX доверяют более <strong>{{monthlyUsers}}</strong> разработчиков ежемесячно.",
  ...
  "home.privacy.body":
    "HopCoderX не хранит ваш код или контекстные данные, поэтому он может работать в средах, чувствительных к приватности.",
  "home.privacy.learnMore": "Подробнее о",
  "home.privacy.link": "приватности",

  "home.faq.q1": "Что такое HopCoderX?",
  "home.faq.a1":
    "HopCoderX — это агент с открытым исходным кодом, который помогает писать и запускать код с любой AI-моделью. Доступен как терминальный интерфейс, десктопное приложение или расширение для IDE.",
  "home.faq.q2": "Как использовать HopCoderX?",
  "home.faq.a2.before": "Проще всего начать с чтения",
  "home.faq.a2.link": "введения",
  "home.faq.q3": "Нужны ли дополнительные подписки на AI для использования HopCoderX?",
  "home.faq.a3.p1":
    "Не обязательно, HopCoderX поставляется с набором бесплатных моделей, которые можно использовать без создания аккаунта.",
  ...
  "home.faq.a3.p3":
    "Хотя мы рекомендуем использовать Bdr, HopCoderX также работает со всеми популярными провайдерами, такими как OpenAI, Anthropic, xAI и др.",
  "home.faq.a3.p4.beforeLocal": "Вы даже можете подключить ваши",
  "home.faq.a3.p4.localLink": "локальные модели",
  "home.faq.q4": "Могу ли я использовать мои существующие AI-подписки с HopCoderX?",
  "home.faq.a4.p1":
    "Да, HopCoderX поддерживает подписки всех основных провайдеров. Вы можете использовать ваши подписки Claude Pro/Max, ChatGPT Plus/Pro или GitHub Copilot.",
  "home.faq.q5": "Можно ли использовать HopCoderX только в терминале?",
  "home.faq.a5.beforeDesktop": "Больше нет! HopCoderX теперь доступен как приложение для",
  "home.faq.a5.desktop": "десктопа",
  "home.faq.a5.and": "и",
  "home.faq.a5.web": "веба",
  "home.faq.q6": "Сколько стоит HopCoderX?",
  "home.faq.a6":
    "HopCoderX на 100% бесплатен. Он также включает набор бесплатных моделей. Дополнительные расходы могут возникнуть, если вы подключите другого провайдера.",
  ...
  "home.faq.q8": "HopCoderX — это open source?",
  "home.faq.a8.p1": "Да, HopCoderX полностью open source. Исходный код доступен публично на",
  "home.faq.a8.p2": "под",
  ...
  "home.bdrCta.title": "Доступ к надежным оптимизированным моделям для кодинг-агентов",
  "home.bdrCta.body":
    "Bdr дает доступ к отобранному набору AI-моделей, которые HopCoderX протестировал и проверил специально для кодинг-агентов. Не нужно беспокоиться о нестабильной производительности и качестве разных провайдеров, используйте проверенные модели, которые работают.",
  "home.bdrCta.link": "Узнать о Bdr",

  "bdr.title": "HopCoderX Bdr | Набор надежных оптимизированных моделей для кодинг-агентов",
  "bdr.hero.title": "Надежные оптимизированные модели для кодинг-агентов",
  "bdr.hero.body":
    "Bdr дает доступ к отобранному набору AI-моделей, которые HopCoderX протестировал и проверил специально для кодинг-агентов. Не нужно беспокоиться о нестабильной производительности и качестве, используйте проверенные модели, которые работают.",

  "bdr.faq.q1": "Что такое HopCoderX Bdr?",
  "bdr.faq.a1":
    "Bdr — это отобранный набор AI-моделей, протестированных и проверенных для кодинг-агентов командой, стоящей за HopCoderX.",
  "bdr.faq.q2": "Почему Bdr точнее?",
  "bdr.faq.a2":
    "Bdr предоставляет только те модели, которые были специально протестированы и проверены для кодинг-агентов. Вы же не режете стейк ножом для масла, не используйте плохие модели для кодинга.",
  "bdr.faq.q3": "Bdr дешевле?",
  "bdr.faq.a3":
    "Bdr — некоммерческий проект. Bdr транслирует расходы от провайдеров моделей вам. Чем больше использование Bdr, тем лучшие тарифы HopCoderX может согласовать и передать вам.",
  "bdr.faq.q4": "Сколько стоит Bdr?",
  "bdr.faq.a4.p1.beforePricing": "Bdr",
  "bdr.faq.a4.p1.pricingLink": "взимает плату за запрос",
  ...
  "bdr.faq.a4.p2.accountLink": "аккаунте",
  "bdr.faq.a4.p3":
    "Для покрытия расходов HopCoderX добавляет лишь небольшую комиссию за обработку платежа в размере $1.23 при пополнении баланса на $20.",
  "bdr.faq.q5": "Как насчет данных и приватности?",
  "bdr.faq.a5.beforeExceptions":
    "Все модели Bdr размещены в США. Провайдеры следуют политике нулевого хранения и не используют ваши данные для обучения моделей, за",
  "bdr.faq.a5.exceptionsLink": "следующими исключениями",
  "bdr.faq.q6": "Могу ли я установить лимиты расходов?",
  "bdr.faq.a6": "Да, вы можете установить ежемесячные лимиты расходов в своем аккаунте.",
  "bdr.faq.q7": "Могу ли я отменить?",
  "bdr.faq.a7": "Да, вы можете отключить оплату в любое время и использовать оставшийся баланс.",
  "bdr.faq.q8": "Могу ли я использовать Bdr с другими кодинг-агентами?",
  "bdr.faq.a8":
    "Хотя Bdr отлично работает с HopCoderX, вы можете использовать Bdr с любым агентом. Следуйте инструкциям по настройке в вашем любимом агенте.",

  "bdr.cta.start": "Начать работу с Bdr",
  "bdr.pricing.title": "Пополнить баланс на $20 (Pay as you go)",
  "bdr.pricing.fee": "(+$1.23 комиссия за обработку карты)",
  "bdr.pricing.body": "Используйте с любым агентом. Установите ежемесячные лимиты. Отмените в любое время.",
  "bdr.problem.title": "Какую проблему решает Bdr?",
  "bdr.problem.body":
  ...
  "bdr.problem.subtitle": "Мы исправляем это для всех, а не только для пользователей HopCoderX.",
  "bdr.problem.item1": "Тестирование избранных моделей и консультации с их командами",
  "bdr.problem.item2": "Работа с провайдерами для обеспечения правильной доставки",
  "bdr.problem.item3": "Бенчмаркинг всех рекомендуемых нами комбинаций модель-провайдер",
  "bdr.how.title": "Как работает Bdr",
  "bdr.how.body": "Хотя мы предлагаем использовать Bdr с HopCoderX, вы можете использовать его с любым агентом.",
  "bdr.how.step1.title": "Зарегистрируйтесь и пополните баланс на $20",
  "bdr.how.step1.beforeLink": "следуйте",
  "bdr.how.step1.link": "инструкциям по настройке",
  "bdr.how.step2.title": "Используйте Bdr с прозрачным ценообразованием",
  "bdr.how.step2.link": "оплата за запрос",
  "bdr.how.step2.afterLink": "с нулевой наценкой",
  "bdr.how.step3.title": "Автопополнение",
  "bdr.how.step3.body": "когда ваш баланс достигнет $5, мы автоматически добавим $20",
  "bdr.privacy.title": "Ваша приватность важна для нас",
  "bdr.privacy.beforeExceptions":
    "Все модели Bdr размещены в США. Провайдеры следуют политике нулевого хранения и не используют ваши данные для обучения моделей, за",
  "bdr.privacy.exceptionsLink": "следующими исключениями",

  "black.meta.title": "HopCoderX Black | Доступ к лучшим моделям для кодинга в мире",
  "black.meta.description": "Получите доступ к Claude, GPT, Gemini и другим моделям с подпиской HopCoderX Black.",
  "black.hero.title": "Доступ к лучшим моделям для кодинга в мире",
  "black.hero.subtitle": "Включая Claude, GPT, Gemini и другие",
  "black.title": "HopCoderX Black | Цены",
  ...
  "black.workspace.title": "HopCoderX Black | Выбор рабочего пространства",
  "black.workspace.selectPlan": "Выберите рабочее пространство для этого плана",
  "black.workspace.name": "Рабочее пространство {{n}}",
  "black.subscribe.title": "Подписаться на HopCoderX Black",
  ...
  "black.subscribe.success.title": "Вы в списке ожидания HopCoderX Black",
  ...
  "workspace.newUser.feature.lockin.body":
    "Используйте Bdr с любым кодинг-агентом и продолжайте использовать других провайдеров с HopCoderX, когда захотите.",
  ...
  "workspace.newUser.step.login.after": "и выберите HopCoderX",
  "workspace.newUser.step.pasteKey": "Вставьте ваш API ключ",
  "workspace.newUser.step.models.before": "Запустите HopCoderX и выполните",
  ...
  "workspace.keys.subtitle": "Управляйте вашими API ключами для доступа к сервисам HopCoderX.",
  "workspace.keys.create": "Создать API ключ",
  "workspace.keys.placeholder": "Введите название ключа",
  "workspace.keys.empty": "Создайте API ключ для шлюза HopCoderX",
  ...
  "workspace.black.subscription.message": "Вы подписаны на HopCoderX Black за ${{plan}} в месяц.",
  ...
  "workspace.black.waitlist.joined": "Вы в списке ожидания плана HopCoderX Black за ${{plan}} в месяц.",
  "workspace.black.waitlist.ready": "Мы готовы подключить вас к плану HopCoderX Black за ${{plan}} в месяц.",
  ...
  "download.title": "HopCoderX | Скачать",
  "download.meta.description": "Скачать HopCoderX для macOS, Windows и Linux",
  "download.hero.title": "Скачать HopCoderX",
  ...
  "download.section.extensions": "Расширения HopCoderX",
  "download.section.integrations": "Интеграции HopCoderX",
  ...
  "download.faq.a3.beforeLocal":
    "Не обязательно, но возможно. Вам понадобится AI подписка, если вы хотите подключить HopCoderX к платному провайдеру, хотя вы можете работать с",
  "download.faq.a3.localLink": "локальными моделями",
  "download.faq.a3.afterLocal.beforeBdr": "бесплатно. Хотя мы рекомендуем использовать",
  "download.faq.a3.afterBdr":
    ", HopCoderX работает со всеми популярными провайдерами, такими как OpenAI, Anthropic, xAI и др.",

  "download.faq.a5.p1": "HopCoderX на 100% бесплатен.",
  "download.faq.a5.p2.beforeBdr":
    "Любые дополнительные расходы будут связаны с вашей подпиской у провайдера моделей. Хотя HopCoderX работает с любым провайдером моделей, мы рекомендуем использовать",
  "download.faq.a5.p2.afterBdr": ".",

  "download.faq.a6.p1": "Ваши данные и информация сохраняются только при создании ссылок для шеринга в HopCoderX.",
  "download.faq.a6.p2.beforeShare": "Подробнее о",
  "download.faq.a6.shareLink": "страницах шеринга",

  "enterprise.title": "HopCoderX | Корпоративные решения для вашей организации",
  "enterprise.meta.description": "Свяжитесь с HopCoderX для корпоративных решений",
  "enterprise.hero.title": "Ваш код принадлежит вам",
  "enterprise.hero.body1":
    "HopCoderX безопасно работает внутри вашей организации: не хранит данные и контекст, без лицензионных ограничений и претензий на собственность. Начните пробный период с командой, затем разверните по всей организации, интегрировав с SSO и внутренним AI-шлюзом.",
  ...
  "enterprise.faq.q1": "Что такое HopCoderX Enterprise?",
  "enterprise.faq.a1":
    "HopCoderX Enterprise предназначен для организаций, которые хотят гарантировать, что их код и данные никогда не покинут их инфраструктуру. Это достигается за счет централизованной конфигурации, интегрированной с вашим SSO и внутренним AI-шлюзом.",
  "enterprise.faq.q2": "Как начать работу с HopCoderX Enterprise?",
  "enterprise.faq.a2":
    "Просто начните с внутреннего триала с вашей командой. HopCoderX по умолчанию не хранит ваш код или контекстные данные, поэтому начать легко. Затем свяжитесь с нами, чтобы обсудить цены и варианты внедрения.",
  ...
  "enterprise.faq.q4": "Безопасны ли мои данные с HopCoderX Enterprise?",
  "enterprise.faq.a4":
    "Да. HopCoderX не хранит ваш код или контекстные данные. Вся обработка происходит локально или через прямые вызовы API к вашему AI-провайдеру. Благодаря централизованной конфигурации и интеграции SSO ваши данные остаются защищенными внутри инфраструктуры вашей организации.",

  "brand.title": "HopCoderX | Бренд",
  "brand.meta.description": "Гайдлайны бренда HopCoderX",
  "brand.heading": "Гайдлайны бренда",
  "brand.subtitle": "Ресурсы и активы, которые помогут вам работать с брендом HopCoderX.",
  "brand.downloadAll": "Скачать все ресурсы",

  "changelog.title": "HopCoderX | Список изменений",
  "changelog.meta.description": "Примечания к релизам и список изменений HopCoderX",
  "changelog.hero.title": "Список изменений",
  "changelog.hero.subtitle": "Новые обновления и улучшения HopCoderX",
