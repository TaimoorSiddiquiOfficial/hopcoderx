...
export const dict = {
  ...
  "notFound.title": "未找到页面 | HopCoderX",
  ...
  "home.title": "HopCoderX | 开源 AI 编程代理",

  "temp.title": "HopCoderX | 专为终端打造的 AI 编程代理",
  ...
  "temp.feature.bdr.beforeLink": "由 HopCoderX 提供的",
  "temp.feature.bdr.link": "精选模型列表",
  "temp.feature.bdr.afterLink": "",
  "temp.feature.models.beforeLink": "通过 Models.dev 支持 75+ LLM 提供商",
  "temp.feature.models.afterLink": "，包括本地模型",
  "temp.screenshot.caption": "使用 Tokyonight 主题的 HopCoderX TUI",
  "temp.screenshot.alt": "使用 Tokyonight 主题的 HopCoderX TUI",
  ...
  "home.what.title": "什么是 HopCoderX？",
  "home.what.body": "HopCoderX 是一个开源代理，帮助您在终端、IDE 或桌面端编写代码。",
  ...
  "home.growth.body":
    "拥有超过 <strong>{{stars}}</strong> 颗 GitHub Star，<strong>{{contributors}}</strong> 位贡献者，以及超过 <strong>{{commits}}</strong> 次提交，HopCoderX 每月被超过 <strong>{{monthlyUsers}}</strong> 名开发者使用并信赖。",
  "home.growth.githubStars": "GitHub Stars",
  "home.growth.contributors": "贡献者",
  "home.growth.monthlyDevs": "月活开发者",

  "home.privacy.title": "隐私优先的设计",
  "home.privacy.body": "HopCoderX 不存储您的任何代码或上下文数据，确保可以在对隐私敏感的环境中运行。",
  "home.privacy.learnMore": "了解更多关于",
  "home.privacy.link": "隐私",

  "home.faq.q1": "什么是 HopCoderX？",
  "home.faq.a1": "HopCoderX 是一个开源代理，帮助您使用任意 AI 模型编写和运行代码。它提供终端界面、桌面应用及 IDE 扩展。",
  "home.faq.q2": "如何使用 HopCoderX？",
  "home.faq.a2.before": "最简单的入门方式是阅读",
  "home.faq.a2.link": "介绍",
  "home.faq.q3": "使用 HopCoderX 需要额外的 AI 订阅吗？",
  "home.faq.a3.p1": "不一定。HopCoderX 自带一组免费模型，无需创建账户即可使用。",
  "home.faq.a3.p2.beforeBdr": "此外，您可以通过创建",
  "home.faq.a3.p2.afterBdr": "账户来使用流行的编程模型。",
  "home.faq.a3.p3": "虽然我们鼓励使用 Bdr，但 HopCoderX 也支持所有主流提供商，如 OpenAI, Anthropic, xAI 等。",
  "home.faq.a3.p4.beforeLocal": "您甚至可以连接您的",
  "home.faq.a3.p4.localLink": "本地模型",
  "home.faq.q4": "我可以使用现有的 AI 订阅吗？",
  "home.faq.a4.p1":
    "可以，HopCoderX 支持所有主流提供商的订阅计划。您可以使用您的 Claude Pro/Max, ChatGPT Plus/Pro, 或 GitHub Copilot 订阅。",
  "home.faq.q5": "HopCoderX 只能在终端使用吗？",
  "home.faq.a5.beforeDesktop": "不再是了！HopCoderX 现在也提供",
  "home.faq.a5.desktop": "桌面端应用",
  "home.faq.a5.and": "和",
  "home.faq.a5.web": "网页端",
  "home.faq.q6": "HopCoderX 多少钱？",
  "home.faq.a6": "HopCoderX 是 100% 免费使用的。它还自带一组免费模型。如果您连接其他提供商，可能会产生额外费用。",
  "home.faq.q7": "数据和隐私如何？",
  ...
  "home.faq.q8": "HopCoderX 是开源的吗？",
  "home.faq.a8.p1": "是的，HopCoderX 是完全开源的。源代码公开在",
  "home.faq.a8.p2": "遵循",
  "home.faq.a8.mitLicense": "MIT 许可证",
  "home.faq.a8.p3":
    "，这意味着任何人都可以使用、修改或为它的发展做贡献。社区中的任何人都可以提交 issue、提交 PR 并扩展功能。",

  "home.bdrCta.title": "访问可靠、优化的编程代理模型",
  "home.bdrCta.body":
    "Bdr 为您提供一组精选的 AI 模型，这些模型经过 HopCoderX 专门针对编程代理的测试和基准测试。无需担心不同提供商之间不稳定的性能和质量，直接使用行之有效的验证模型。",
  "home.bdrCta.link": "了解 Bdr",

  "bdr.title": "HopCoderX Bdr | 为编程代理精选的可靠、优化模型",
  "bdr.hero.title": "为编程代理打造的可靠、优化模型",
  "bdr.hero.body":
    "Bdr 为您提供一组精选的 AI 模型，这些模型经过 HopCoderX 专门针对编程代理的测试和基准测试。无需担心不稳定的性能和质量，直接使用行之有效的验证模型。",

  "bdr.faq.q1": "什么是 HopCoderX Bdr？",
  "bdr.faq.a1": "Bdr 是一组由 HopCoderX 团队创建的，专门针对编程代理进行测试和基准测试的 AI 模型精选集。",
  "bdr.faq.q2": "为什么 Bdr 更准确？",
  "bdr.faq.a2":
    "Bdr 仅提供经过专门针对编程代理测试和基准测试的模型。正如你不会用黄油刀切牛排一样，也不要用糟糕的模型来写代码。",
  "bdr.faq.q3": "Bdr 更便宜吗？",
  "bdr.faq.a3":
    "Bdr 不以盈利为目的。Bdr 将模型提供商的成本直接传递给您。Bdr 的使用量越高，HopCoderX 就越能协商出更好的费率并回馈给您。",
  "bdr.faq.q4": "Bdr 多少钱？",
  "bdr.faq.a4.p1.beforePricing": "Bdr",
  "bdr.faq.a4.p1.pricingLink": "按请求收费",
  "bdr.faq.a4.p1.afterPricing": "零加价，所以您只需支付模型提供商收取的费用。",
  "bdr.faq.a4.p2.beforeAccount": "您的总费用取决于使用量，且您可以在您的",
  "bdr.faq.a4.p2.accountLink": "账户中设置每月支出限额",
  "bdr.faq.a4.p3": "为覆盖成本，HopCoderX 仅收取少量支付处理费，每充值 $20 收取 $1.23。",
  "bdr.faq.q5": "数据和隐私如何？",
  "bdr.faq.a5.beforeExceptions": "所有 Bdr 模型均托管在美国。提供商遵循零留存政策，不使用您的数据进行模型训练，",
  "bdr.faq.a5.exceptionsLink": "以下例外情况除外",
  "bdr.faq.q6": "我可以设置支出限额吗？",
  "bdr.faq.a6": "可以，您可以在账户中设置每月支出限额。",
  "bdr.faq.q7": "我可以取消吗？",
  "bdr.faq.a7": "可以，您可以随时禁用计费并使用剩余余额。",
  "bdr.faq.q8": "我可以在其他编程代理中使用 Bdr 吗？",
  "bdr.faq.a8":
    "虽然 Bdr 与 HopCoderX 配合效果极佳，但您可以在任何代理中使用 Bdr。请按照您首选编程代理中的设置说明进行操作。",

  "bdr.cta.start": "开始使用 Bdr",
  "bdr.pricing.title": "充值 $20 (即用即付)",
  "bdr.pricing.fee": "(+ $1.23 银行卡手续费)",
  "bdr.pricing.body": "可配合任何代理使用。支持设置月度消费限额。随时取消。",
  "bdr.problem.title": "Bdr 解决了什么问题？",
  "bdr.problem.body": "市面上有太多模型，但只有少数能与编程代理良好配合。大多数提供商配置不同，导致结果参差不齐。",
  "bdr.problem.subtitle": "我们要为所有人解决这个问题，不仅仅是 HopCoderX 用户。",
  "bdr.problem.item1": "测试精选模型并咨询其团队",
  "bdr.problem.item2": "与提供商合作确保正确交付",
  "bdr.problem.item3": "对所有推荐的模型-提供商组合进行基准测试",
  "bdr.how.title": "Bdr 如何工作",
  "bdr.how.body": "虽然我们建议您配合 HopCoderX 使用 Bdr，但您也可以将其用于任何代理。",
  "bdr.how.step1.title": "注册并充值 $20",
  "bdr.how.step1.beforeLink": "遵循",
  "bdr.how.step1.link": "设置说明",
  "bdr.how.step2.title": "使用 Bdr，价格透明",
  "bdr.how.step2.link": "按请求付费",
  "bdr.how.step2.afterLink": "零加价",
  "bdr.how.step3.title": "自动充值",
  "bdr.how.step3.body": "当您的余额低于 $5 时，我们将自动充值 $20",
  "bdr.privacy.title": "您的隐私对我们很重要",
  "bdr.privacy.beforeExceptions": "所有 Bdr 模型均托管在美国。提供商遵循零留存政策，不使用您的数据进行模型训练，",
  "bdr.privacy.exceptionsLink": "以下例外情况除外",

  "black.meta.title": "HopCoderX Black | 访问全球顶尖编程模型",
  "black.meta.description": "通过 HopCoderX Black 订阅计划使用 Claude, GPT, Gemini 等模型。",
  "black.hero.title": "访问全球顶尖编程模型",
  "black.hero.subtitle": "包括 Claude, GPT, Gemini 等",
  "black.title": "HopCoderX Black | 定价",
  ...
  "black.workspace.title": "HopCoderX Black | 选择工作区",
  "black.workspace.selectPlan": "为此计划选择一个工作区",
  "black.workspace.name": "工作区 {{n}}",
  "black.subscribe.title": "订阅 HopCoderX Black",
  ...
  "black.subscribe.success.title": "您已加入 HopCoderX Black 候补名单",
  ...
  "workspace.newUser.feature.lockin.body":
    "将 Bdr 与任何编程代理结合使用，并在需要时继续在 HopCoderX 中使用其他提供商。",
  ...
  "workspace.newUser.step.login.after": "并选择 HopCoderX",
  "workspace.newUser.step.pasteKey": "粘贴您的 API 密钥",
  "workspace.newUser.step.models.before": "启动 HopCoderX 并运行",
  ...
  "workspace.keys.subtitle": "管理访问 HopCoderX 服务的 API 密钥。",
  "workspace.keys.create": "创建 API 密钥",
  "workspace.keys.placeholder": "输入密钥名称",
  "workspace.keys.empty": "创建 HopCoderX 网关 API 密钥",
  ...
  "workspace.black.subscription.message": "您已订阅 HopCoderX Black，价格为每月 ${{plan}}。",
  ...
  "workspace.black.waitlist.joined": "您已加入每月 ${{plan}} 的 HopCoderX Black 计划候补名单。",
  "workspace.black.waitlist.ready": "我们已准备好将您加入每月 ${{plan}} 的 HopCoderX Black 计划。",
  ...
  "download.title": "HopCoderX | 下载",
  "download.meta.description": "下载适用于 macOS, Windows, 和 Linux 的 HopCoderX",
  "download.hero.title": "下载 HopCoderX",
  "download.hero.subtitle": "适用于 macOS, Windows, 和 Linux 的 Beta 版",
  "download.hero.button": "下载 {{os}} 版",
  "download.section.terminal": "HopCoderX 终端",
  "download.section.desktop": "HopCoderX 桌面版 (Beta)",
  "download.section.extensions": "HopCoderX 扩展",
  "download.section.integrations": "HopCoderX 集成",
  ...
  "download.faq.a3.beforeLocal":
    "不一定，但可能需要。如果您想将 HopCoderX 连接到付费提供商，您需要 AI 订阅，尽管您可以配合",
  "download.faq.a3.localLink": "本地模型",
  "download.faq.a3.afterLocal.beforeBdr": "免费使用。虽然我们鼓励用户使用",
  "download.faq.a3.afterBdr": "，但 HopCoderX 支持所有主流提供商，如 OpenAI, Anthropic, xAI 等。",

  "download.faq.a5.p1": "HopCoderX 是 100% 免费使用的。",
  "download.faq.a5.p2.beforeBdr":
    "任何额外费用都来自您对模型提供商的订阅。虽然 HopCoderX 支持任何模型提供商，但我们建议使用",
  "download.faq.a5.p2.afterBdr": "。",

  "download.faq.a6.p1": "只有当您在 HopCoderX 中创建分享链接时，您的数据和信息才会被存储。",
  "download.faq.a6.p2.beforeShare": "了解更多关于",
  "download.faq.a6.shareLink": "分享页面",

  "enterprise.title": "HopCoderX | 面向组织的 HopCoderX 企业版解决方案",
  "enterprise.meta.description": "联系 HopCoderX 获取企业版解决方案",
  "enterprise.hero.title": "您的代码属于您",
  "enterprise.hero.body1":
    "HopCoderX 在您的组织内部安全运行，不存储任何数据或上下文，也没有许可限制或所有权主张。您可以先与团队开始试用，然后通过集成 SSO 和内部 AI 网关将其部署到整个组织。",
  ...
  "enterprise.faq.q1": "什么是 HopCoderX 企业版？",
  "enterprise.faq.a1":
    "HopCoderX 企业版专为那些希望确保代码和数据永远不离开其基础设施的组织而设计。它通过使用集中式配置，与您的 SSO 和内部 AI 网关集成来实现这一点。",
  "enterprise.faq.q2": "如何开始使用 HopCoderX 企业版？",
  "enterprise.faq.a2":
    "只需从您的团队内部试用开始即可。HopCoderX 默认不存储您的代码或上下文数据，使得入门非常容易。然后联系我们讨论定价和实施选项。",
  "enterprise.faq.q3": "企业版定价如何运作？",
  "enterprise.faq.a3":
    "我们提供按席位计费的企业定价。如果您拥有自己的 LLM 网关，我们不收取 token 使用费。如需了解更多详情，请联系我们获取基于您组织需求的定制报价。",
  "enterprise.faq.q4": "HopCoderX 企业版安全吗？",
  "enterprise.faq.a4":
    "是的。HopCoderX 不存储您的代码或上下文数据。所有处理均在本地进行，或通过直接 API 调用您的 AI 提供商。通过集中配置和 SSO 集成，您的数据始终保留在您组织的基础设施内。",

  "brand.title": "HopCoderX | 品牌",
  "brand.meta.description": "HopCoderX 品牌指南",
  "brand.heading": "品牌指南",
  "brand.subtitle": "帮助您使用 HopCoderX 品牌的资源和资产。",
  "brand.downloadAll": "下载所有资产",

  "changelog.title": "HopCoderX | 更新日志",
  "changelog.meta.description": "HopCoderX 发布说明和更新日志",
  "changelog.hero.title": "更新日志",
  "changelog.hero.subtitle": "HopCoderX 的新更新和改进",
