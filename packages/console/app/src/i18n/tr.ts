...
export const dict = {
  ...
  "notFound.title": "Bulunamadı | HopCoderX",
  ...
  "home.title": "HopCoderX | Açık kaynaklı yapay zeka kodlama ajanı",
  ...
  "temp.screenshot.alt": "tokyonight temalı HopCoderX TUI",
  ...
  "home.what.title": "HopCoderX nedir?",
  "home.what.body":
    "HopCoderX, terminalinizde, IDE'nizde veya masaüstünde kod yazmanıza yardım eden açık kaynaklı bir ajandır.",
  ...
  "home.growth.body":
    "GitHub'da <strong>{{stars}}</strong>+ yıldız, <strong>{{contributors}}</strong> katılımcı ve <strong>{{commits}}</strong>+ commit ile HopCoderX, her ay <strong>{{monthlyUsers}}</strong>+ geliştirici tarafından kullanılıyor ve güveniliyor.",
  ...
  "home.privacy.body":
    "HopCoderX kodunuzu veya bağlam verilerinizi saklamaz; bu sayede gizliliğe duyarlı ortamlarda çalışabilir.",
  "home.privacy.learnMore": "Hakkında daha fazla bilgi:",
  "home.privacy.link": "gizlilik",

  "home.faq.q1": "HopCoderX nedir?",
  "home.faq.a1":
    "HopCoderX, herhangi bir AI modeliyle kod yazmanıza ve çalıştırmanıza yardım eden açık kaynaklı bir ajandır. Terminal arayüzü, masaüstü uygulaması veya IDE uzantısı olarak kullanılabilir.",
  "home.faq.q2": "HopCoderX'u nasıl kullanırım?",
  ...
  "home.faq.a4.p1":
    "Evet. HopCoderX tüm büyük sağlayıcıların aboneliklerini destekler. Claude Pro/Max, ChatGPT Plus/Pro veya GitHub Copilot kullanabilirsiniz.",
  "home.faq.q5": "HopCoderX'u sadece terminalde mi kullanabilirim?",
  "home.faq.a5.beforeDesktop": "Artık hayır! HopCoderX şimdi",
  "home.faq.a5.desktop": "masaüstü",
  "home.faq.a5.and": "ve",
  "home.faq.a5.web": "web",
  "home.faq.q6": "HopCoderX ne kadar?",
  "home.faq.a6":
    "HopCoderX %100 ücretsizdir. Ayrıca ücretsiz model setiyle gelir. Başka bir sağlayıcı bağlarsanız ek maliyetler olabilir.",
  ...
  "home.faq.q8": "HopCoderX açık kaynak mı?",
  "home.faq.a8.p1": "Evet, HopCoderX tamamen açık kaynaktır. Kaynak kodu",
  ...
  "black.title": "HopCoderX Black | Fiyatlandırma",
  ...
  "black.workspace.title": "HopCoderX Black | Çalışma Alanı Seç",
  "black.workspace.selectPlan": "Bu plan için bir çalışma alanı seçin",
  "black.workspace.name": "Çalışma Alanı {{n}}",
  "black.subscribe.title": "HopCoderX Black'e Abone Ol",
  ...
  "black.subscribe.success.title": "HopCoderX Black bekleme listesindesiniz",
  ...
  "workspace.newUser.step.login.after": "ve HopCoderX seçeneğini seçin",
  "workspace.newUser.step.pasteKey": "API anahtarınızı yapıştırın",
  "workspace.newUser.step.models.before": "HopCoderX'u başlatın ve çalıştırın",
  ...
  "workspace.keys.subtitle": "HopCoderX hizmetlerine erişim için API anahtarlarınızı yönetin.",
  "workspace.keys.create": "API Anahtarı Oluştur",
  "workspace.keys.placeholder": "Anahtar adını girin",
  "workspace.keys.empty": "Bir HopCoderX Gateway API anahtarı oluşturun",
  ...
  "workspace.black.subscription.message": "Aylık ${{plan}} karşılığında HopCoderX Black'e abonesiniz.",
  ...
  "workspace.black.waitlist.joined": "Aylık ${{plan}} HopCoderX Black planı için bekleme listesindesiniz.",
  "workspace.black.waitlist.ready": "Sizi ayda {{plan}} $ tutarındaki HopCoderX Black planına kaydetmeye hazırız.",
  ...
  "download.title": "HopCoderX | İndir",
  "download.meta.description": "HopCoderX'u macOS, Windows ve Linux için indirin",
  "download.hero.title": "HopCoderX'u İndir",
  ...
  "download.section.extensions": "HopCoderX Eklentileri",
  "download.section.integrations": "HopCoderX Entegrasyonları",
  ...
  "enterprise.title": "HopCoderX | Kurumunuz için kurumsal çözümler",
  "enterprise.meta.description": "Kurumsal çözümler için HopCoderX ile iletişime geçin",
  "enterprise.hero.title": "Kodunuz size aittir",
  "enterprise.hero.body1":
    "HopCoderX, hiçbir veri veya bağlam saklamadan ve lisans kısıtlamaları ya da sahiplik iddiaları olmadan kuruluşunuzun içinde güvenli şekilde çalışır. Ekibinizle bir deneme başlatın, ardından SSO'nuz ve dahili AI geçidiniz ile entegre ederek tüm kuruluşunuzda devreye alın.",
  ...
  "enterprise.faq.q1": "HopCoderX Enterprise nedir?",
  "enterprise.faq.a1":
    "HopCoderX Enterprise, kodunuzun ve verilerinizin asla altyapınızı terk etmemesini sağlamak isteyen kurumlar içindir. Bunu, SSO'nuz ve dahili AI geçidiniz ile entegre olan merkezileştirilmiş bir konfigürasyonla sağlar.",
  "enterprise.faq.q2": "HopCoderX Enterprise'a nasıl başlarım?",
  "enterprise.faq.a2":
    "Ekibinizle dahili bir deneme ile başlayın. HopCoderX varsayılan olarak kodunuzu veya bağlam verilerinizi saklamaz, bu da başlamayı kolaylaştırır. Ardından fiyatlandırma ve uygulama seçeneklerini görüşmek için bize ulaşın.",
  ...
  "enterprise.faq.q4": "HopCoderX Enterprise ile verilerim güvende mi?",
  "enterprise.faq.a4":
    "Evet. HopCoderX kodunuzu veya bağlam verilerinizi saklamaz. Tüm işleme yerel olarak ya da AI sağlayıcınıza doğrudan API çağrıları ile gerçekleştirilir. Merkezileştirilmiş konfigürasyon ve SSO entegrasyonu ile verileriniz kurumunuzun altyapısı içinde güvende kalır.",

  "brand.title": "HopCoderX | Marka",
  "brand.meta.description": "HopCoderX marka kılavuzu",
  "brand.heading": "Marka kılavuzu",
  "brand.subtitle": "HopCoderX markası ile çalışmanıza yardımcı olacak kaynaklar ve varlıklar.",
  "brand.downloadAll": "Tüm varlıkları indir",

  "changelog.title": "HopCoderX | Değişiklik günlüğü",
  "changelog.meta.description": "HopCoderX sürüm notları ve değişiklik günlüğü",
  "changelog.hero.title": "Değişiklik günlüğü",
  "changelog.hero.subtitle": "HopCoderX için yeni güncellemeler ve iyileştirmeler",
