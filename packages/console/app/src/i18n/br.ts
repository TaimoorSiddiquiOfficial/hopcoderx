...
export const dict = {
  ...
  "notFound.title": "Não encontrado | HopCoderX",
  ...
  "home.title": "HopCoderX | O agente de codificação de código aberto com IA",
  ...
  "temp.screenshot.alt": "HopCoderX TUI com tema tokyonight",
  ...
  "home.what.title": "O que é HopCoderX?",
  "home.what.body":
    "HopCoderX é um agente de código aberto que ajuda você a escrever código no seu terminal, IDE ou desktop.",
  ...
  "home.growth.body":
    "Com mais de <strong>{{stars}}</strong> estrelas no GitHub, <strong>{{contributors}}</strong> colaboradores e mais de <strong>{{commits}}</strong> commits, HopCoderX é usado e confiado por mais de <strong>{{monthlyUsers}}</strong> desenvolvedores todos os meses.",
  ...
  "home.faq.q1": "O que é HopCoderX?",
  "home.faq.a1":
    "HopCoderX é um agente de código aberto que ajuda você a escrever e executar código com qualquer modelo de IA. Está disponível como interface de terminal, app desktop ou extensão de IDE.",
  "home.faq.q2": "Como eu uso o HopCoderX?",
  ...
  "home.faq.a4.p1":
    "Sim, HopCoderX suporta planos de assinatura de todos os principais provedores. Você pode usar suas assinaturas Claude Pro/Max, ChatGPT Plus/Pro ou GitHub Copilot.",
  "home.faq.q5": "Posso usar o HopCoderX apenas no terminal?",
  "home.faq.a5.beforeDesktop": "Não mais! HopCoderX agora está disponível como um app para o seu",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "e",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Quanto custa o HopCoderX?",
  "home.faq.a6":
  ...
  "home.faq.q8": "HopCoderX é código aberto?",
  "home.faq.a8.p1": "Sim, HopCoderX é totalmente open source. O código-fonte é público no",
  ...
  "black.title": "HopCoderX Black | Preços",
  ...
  "black.workspace.title": "HopCoderX Black | Selecionar Workspace",
  "black.workspace.selectPlan": "Selecione um workspace para este plano",
  "black.workspace.name": "Workspace {{n}}",
  "black.subscribe.title": "Assinar HopCoderX Black",
  ...
  "black.subscribe.success.title": "Você está na lista de espera do HopCoderX Black",
  ...
  "workspace.newUser.step.login.after": "e selecione HopCoderX",
  "workspace.newUser.step.pasteKey": "Cole sua chave de API",
  "workspace.newUser.step.models.before": "Inicie o HopCoderX e execute",
  ...
  "workspace.keys.subtitle": "Gerencie suas chaves de API para acessar os serviços HopCoderX.",
  "workspace.keys.create": "Criar Chave de API",
  "workspace.keys.placeholder": "Digite o nome da chave",
  "workspace.keys.empty": "Crie uma chave de API do HopCoderX Gateway",
  ...
  "workspace.black.subscription.message": "Você assina o HopCoderX Black por ${{plan}} por mês.",
  ...
  "workspace.black.waitlist.joined": "Você está na lista de espera para o plano HopCoderX Black de ${{plan}} por mês.",
  "workspace.black.waitlist.ready": "Estamos prontos para inscrever você no plano HopCoderX Black de ${{plan}} por mês.",
  ...
  "download.title": "HopCoderX | Baixar",
  "download.meta.description": "Baixe o HopCoderX para macOS, Windows e Linux",
  "download.hero.title": "Baixar HopCoderX",
  ...
  "download.section.extensions": "Extensões HopCoderX",
  "download.section.integrations": "Integrações HopCoderX",
  ...
  "enterprise.title": "HopCoderX | Soluções empresariais para sua organização",
  ...
  "enterprise.faq.q1": "O que é HopCoderX Enterprise?",
  "enterprise.faq.a1":
  ...
  "brand.subtitle": "Recursos e ativos para ajudá-lo a trabalhar com a marca HopCoderX.",
  "brand.downloadAll": "Baixar todos os recursos",

  "changelog.title": "HopCoderX | Changelog",
  "changelog.meta.description": "Notas de versão e changelog do HopCoderX",
  "changelog.hero.title": "Changelog",
  "changelog.hero.subtitle": "Novas atualizações e melhorias no HopCoderX",
