...
export const dict = {
  ...
  "notFound.title": "Nicht gefunden | HopCoderX",
  ...
  "home.title": "HopCoderX | Der Open-Source AI-Coding-Agent",
  ...
  "temp.screenshot.alt": "HopCoderX TUI mit Tokyonight-Theme",
  ...
  "home.what.title": "Was ist HopCoderX?",
  "home.what.body":
    "HopCoderX ist ein Open-Source-Agent, der dir hilft, Code in deinem Terminal, deiner IDE oder auf dem Desktop zu schreiben.",
  ...
  "home.growth.body":
    "Mit über <strong>{{stars}}</strong> GitHub-Stars, <strong>{{contributors}}</strong> Contributors und über <strong>{{commits}}</strong> Commits wird HopCoderX von über <strong>{{monthlyUsers}}</strong> Entwickler:innen jeden Monat genutzt und geschätzt.",
  ...
  "home.privacy.body":
    "HopCoderX speichert keinen deiner Codes oder Kontextdaten, sodass es in datenschutzsensiblen Umgebungen arbeiten kann.",
  "home.privacy.learnMore": "Erfahre mehr über",
  "home.privacy.link": "Datenschutz",

  "home.faq.q1": "Was ist HopCoderX?",
  "home.faq.a1":
    "HopCoderX ist ein Open-Source-Agent, der dir hilft, Code mit jedem KI-Modell zu schreiben und auszuführen. Er ist als Terminal-Interface, Desktop-App oder IDE-Erweiterung verfügbar.",
  ...
  "home.faq.q6": "Wie viel kostet HopCoderX?",
  "home.faq.a6":
    "HopCoderX ist zu 100% kostenlos. Es enthält auch eine Reihe kostenloser Modelle. Zusätzliche Kosten können entstehen, wenn du andere Anbieter verbindest.",
  ...
  "black.title": "HopCoderX Black | Preise",
  ...
  "black.workspace.title": "HopCoderX Black | Workspace wählen",
  "black.workspace.selectPlan": "Wähle einen Workspace für diesen Plan",
  "black.workspace.name": "Workspace {{n}}",
  "black.subscribe.title": "HopCoderX Black abonnieren",
  ...
  "black.subscribe.success.title": "Du bist auf der HopCoderX Black Warteliste",
  ...
  "workspace.newUser.step.login.after": "aus und wähle HopCoderX",
  "workspace.newUser.step.pasteKey": "Füge deinen API Key ein",
  "workspace.newUser.step.models.before": "Starte HopCoderX und führe",
  ...
  "workspace.keys.subtitle": "Verwalte deine API Keys für den Zugriff auf HopCoderX-Dienste.",
  "workspace.keys.create": "API Key erstellen",
  "workspace.keys.placeholder": "Key-Namen eingeben",
  "workspace.keys.empty": "Erstelle einen HopCoderX Gateway API Key",
  ...
  "workspace.black.subscription.message": "Du hast HopCoderX Black für ${{plan}} pro Monat abonniert.",
  ...
  "workspace.black.waitlist.joined": "Du bist auf der Warteliste für den ${{plan}} pro Monat HopCoderX Black Plan.",
  "workspace.black.waitlist.ready": "Wir sind bereit, dich in den ${{plan}} pro Monat HopCoderX Black Plan aufzunehmen.",
  ...
  "download.meta.description": "Lade HopCoderX für macOS, Windows und Linux herunter",
  "download.hero.title": "HopCoderX herunterladen",
  ...
  "download.section.integrations": "HopCoderX Integrationen",
  ...
  "enterprise.title": "HopCoderX | Enterprise-Lösungen für Ihre Organisation",
  ...
  "brand.subtitle": "Ressourcen und Assets, die dir helfen, mit der HopCoderX-Marke zu arbeiten.",
  "brand.downloadAll": "Alle Assets herunterladen",

  "changelog.title": "HopCoderX | Changelog",
  "changelog.meta.description": "HopCoderX Release Notes und Changelog",
  "changelog.hero.title": "Changelog",
  "changelog.hero.subtitle": "Neue Updates und Verbesserungen für HopCoderX",
