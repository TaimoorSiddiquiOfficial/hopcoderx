...
export const dict = {
  ...
  "notFound.title": "找不到頁面 | HopCoderX",
  ...
  "home.title": "HopCoderX | 開源 AI 編碼代理",

  "temp.title": "HopCoderX | 專為終端打造的 AI 編碼代理",
  ...
  "temp.feature.bdr.link": "精選模型列表",
  "temp.feature.bdr.afterLink": "由 HopCoderX 提供",
  "temp.feature.models.beforeLink": "透過",
  "temp.feature.models.afterLink": "支援 75+ 家 LLM 供應商，包括本地模型",
  "temp.screenshot.caption": "使用 tokyonight 主題的 HopCoderX TUI",
  "temp.screenshot.alt": "使用 tokyonight 主題的 HopCoderX TUI",
  ...
  "home.what.title": "什麼是 HopCoderX？",
  "home.what.body": "HopCoderX 是一個開源代理，幫助你在終端、IDE 或桌面端編寫程式碼。",
  ...
  "home.growth.body":
    "擁有超過 <strong>{{stars}}</strong> 個 GitHub Star、<strong>{{contributors}}</strong> 位貢獻者以及超過 <strong>{{commits}}</strong> 次提交，HopCoderX 每月被超過 <strong>{{monthlyUsers}}</strong> 名開發者使用並信賴。",
  "home.growth.githubStars": "GitHub Star",
  "home.growth.contributors": "貢獻者",
  "home.growth.monthlyDevs": "每月活躍開發者",

  "home.privacy.title": "隱私優先",
  "home.privacy.body": "HopCoderX 不儲存你的程式碼或上下文資料，因此可以在注重隱私的環境中運作。",
  "home.privacy.learnMore": "了解更多關於",
  "home.privacy.link": "隱私",

  "home.faq.q1": "什麼是 HopCoderX？",
  "home.faq.a1":
    "HopCoderX 是一個開源代理，幫助你使用任意 AI 模型編寫並執行程式碼。它提供終端介面、桌面應用程式或 IDE 擴充功能。",
  "home.faq.q2": "如何使用 HopCoderX？",
  "home.faq.a2.before": "最簡單的方式是先閱讀",
  "home.faq.a2.link": "入門介紹",
  "home.faq.q3": "使用 HopCoderX 需要額外的 AI 訂閱嗎？",
  "home.faq.a3.p1": "不一定。HopCoderX 自帶一組免費模型，無需建立帳號即可使用。",
  "home.faq.a3.p2.beforeBdr": "此外，你可以透過建立",
  "home.faq.a3.p2.afterBdr": "帳號使用常見的編碼模型。",
  "home.faq.a3.p3": "我們鼓勵使用 Bdr，但 HopCoderX 也支援 OpenAI、Anthropic、xAI 等主流供應商。",
  "home.faq.a3.p4.beforeLocal": "你還可以連接你的",
  "home.faq.a3.p4.localLink": "本地模型",
  "home.faq.q4": "可以使用我現有的 AI 訂閱嗎？",
  "home.faq.a4.p1":
    "可以。HopCoderX 支援主流供應商的訂閱方案，包括 Claude Pro/Max、ChatGPT Plus/Pro 與 GitHub Copilot。",
  "home.faq.q5": "HopCoderX 只能在終端中使用嗎？",
  "home.faq.a5.beforeDesktop": "不再是了！HopCoderX 現在也提供",
  "home.faq.a5.desktop": "桌面端",
  "home.faq.a5.and": "與",
  "home.faq.a5.web": "網頁端",
  "home.faq.q6": "HopCoderX 價格如何？",
  "home.faq.a6": "HopCoderX 100% 免費使用。它也自帶一組免費模型。如果你連接其他供應商，可能會產生額外費用。",
  ...
  "home.faq.q8": "HopCoderX 是開源的嗎？",
  "home.faq.a8.p1": "是的，HopCoderX 完全開源。原始碼公開在",
  "home.faq.a8.p2": "並採用",
  "home.faq.a8.mitLicense": "MIT 授權條款",
  "home.faq.a8.p3": "，意味著任何人都可以使用、修改或貢獻。社群中的任何人都可以提交 issue、pull requests 並擴充功能。",

  "home.bdrCta.title": "存取可靠且最佳化的編碼代理模型",
  "home.bdrCta.body":
    "Bdr 提供一組精選的 AI 模型，這些模型是 HopCoderX 為了編碼代理專門測試與評測過的。無需擔心不同供應商之間效能與品質參差不齊，使用經過驗證的模型即可。",
  "home.bdrCta.link": "了解 Bdr",

  "bdr.title": "HopCoderX Bdr | 專為編碼代理精選的可靠最佳化模型",
  "bdr.hero.title": "專為編碼代理提供的可靠最佳化模型",
  "bdr.hero.body":
    "Bdr 提供一組精選的 AI 模型，這些模型是 HopCoderX 為了編碼代理專門測試與評測過的。無需擔心效能與品質參差不齊，使用經過驗證的模型即可。",

  "bdr.faq.q1": "什麼是 HopCoderX Bdr？",
  "bdr.faq.a1": "Bdr 是由 HopCoderX 團隊打造、專為編碼代理測試與評測的 AI 模型精選集合。",
  "bdr.faq.q2": "是什麼讓 Bdr 更準確？",
  "bdr.faq.a2": "Bdr 只提供專為編碼代理測試與評測的模型。你不會用奶油刀切牛排，也別用糟糕的模型來寫程式。",
  "bdr.faq.q3": "Bdr 更便宜嗎？",
  "bdr.faq.a3":
    "Bdr 不以營利為目的。Bdr 會把模型供應商的成本原樣轉給你。Bdr 的使用量越高，HopCoderX 就越能談到更好的價格並把優惠讓利給你。",
  "bdr.faq.q4": "Bdr 費用是多少？",
  "bdr.faq.a4.p1.beforePricing": "Bdr",
  "bdr.faq.a4.p1.pricingLink": "按請求付費",
  "bdr.faq.a4.p1.afterPricing": "且零加價，因此你支付的就是模型供應商的原價。",
  "bdr.faq.a4.p2.beforeAccount": "總費用取決於使用量，你可以在",
  "bdr.faq.a4.p2.accountLink": "帳戶中設定每月支出上限",
  "bdr.faq.a4.p3": "為了覆蓋成本，HopCoderX 只會收取很小的支付處理費：每次儲值 $20 會額外收取 $1.23。",
  "bdr.faq.q5": "資料與隱私如何？",
  "bdr.faq.a5.beforeExceptions": "所有 Bdr 模型都託管在美國。供應商遵循零留存政策，不會將你的資料用於模型訓練，但有",
  "bdr.faq.a5.exceptionsLink": "以下例外",
  "bdr.faq.q6": "我可以設定支出上限嗎？",
  "bdr.faq.a6": "可以，你可以在帳戶中設定每月支出上限。",
  "bdr.faq.q7": "我可以取消嗎？",
  "bdr.faq.a7": "可以，你可以隨時停用計費並使用剩餘餘額。",
  "bdr.faq.q8": "我可以在其他編碼代理中使用 Bdr 嗎？",
  "bdr.faq.a8":
    "Bdr 與 HopCoderX 搭配得很好，但你也可以在任何代理中使用 Bdr。請在你偏好的編碼代理中按照設定說明進行配置。",

  "bdr.cta.start": "開始使用 Bdr",
  "bdr.pricing.title": "儲值 $20 即用即付餘額",
  "bdr.pricing.fee": "（+$1.23 刷卡手續費）",
  "bdr.pricing.body": "可與任何代理一起使用。設定每月支出限額。隨時取消。",
  "bdr.problem.title": "Bdr 正在解決什麼問題？",
  "bdr.problem.body":
    "可用的模型有很多，但只有少數可以與編碼代理配合良好。大多數供應商以不同的方式配置它們，導致結果參差不齊。",
  "bdr.problem.subtitle": "我們正在為所有人解決此問題，而不僅僅是 HopCoderX 使用者。",
  "bdr.problem.item1": "測試選定的模型並諮詢其團隊",
  "bdr.problem.item2": "與供應商合作以確保正確交付",
  "bdr.problem.item3": "對我們推薦的所有模型-供應商組合進行基準測試",
  "bdr.how.title": "Bdr 如何運作",
  "bdr.how.body": "雖然我們建議你將 Bdr 與 HopCoderX 一起使用，但你可以將 Bdr 與任何代理一起使用。",
  "bdr.how.step1.title": "註冊並儲值 $20 餘額",
  "bdr.how.step1.beforeLink": "遵循",
  "bdr.how.step1.link": "設定說明",
  "bdr.how.step2.title": "使用 Bdr 並享有透明定價",
  "bdr.how.step2.link": "按請求付費",
  "bdr.how.step2.afterLink": "零加價",
  "bdr.how.step3.title": "自動儲值",
  "bdr.how.step3.body": "當你的餘額達到 $5 時，我們會自動儲值 $20",
  "bdr.privacy.title": "你的隱私對我們很重要",
  "bdr.privacy.beforeExceptions": "所有 Bdr 模型均在美國託管。供應商遵循零留存政策，不會將你的資料用於模型訓練，並且有",
  "bdr.privacy.exceptionsLink": "以下例外情況",

  "black.meta.title": "HopCoderX Black | 存取全球最佳編碼模型",
  "black.meta.description": "透過 HopCoderX Black 訂閱方案存取 Claude、GPT、Gemini 等模型。",
  "black.hero.title": "存取全球最佳編碼模型",
  "black.hero.subtitle": "包括 Claude、GPT、Gemini 等",
  "black.title": "HopCoderX Black | 定價",
  ...
  "black.workspace.title": "HopCoderX Black | 選擇工作區",
  "black.workspace.selectPlan": "為此方案選擇一個工作區",
  "black.workspace.name": "工作區 {{n}}",
  "black.subscribe.title": "訂閱 HopCoderX Black",
  ...
  "black.subscribe.success.title": "你已在 HopCoderX Black 候補名單上",
  ...
  "workspace.newUser.feature.lockin.body":
    "將 Bdr 與任何編碼代理結合使用，並在需要時隨時使用 HopCoderX 連接其他供應商。",
  ...
  "workspace.newUser.step.login.after": "並選擇 HopCoderX",
  "workspace.newUser.step.pasteKey": "貼上你的 API 金鑰",
  "workspace.newUser.step.models.before": "啟動 HopCoderX 並執行",
  ...
  "workspace.keys.subtitle": "管理你的 API 金鑰以存取 HopCoderX 服務。",
  "workspace.keys.create": "建立 API 金鑰",
  "workspace.keys.placeholder": "輸入金鑰名稱",
  "workspace.keys.empty": "建立 HopCoderX 閘道器 API 金鑰",
  ...
  "workspace.black.subscription.message": "你已訂閱 HopCoderX Black，費用為每月 ${{plan}}。",
  ...
  "workspace.black.waitlist.joined": "你已加入每月 ${{plan}} 的 HopCoderX Black 方案候補名單。",
  "workspace.black.waitlist.ready": "我們已準備好將你加入每月 ${{plan}} 的 HopCoderX Black 方案。",
  ...
  "download.title": "HopCoderX | 下載",
  "download.meta.description": "下載適用於 macOS、Windows 與 Linux 的 HopCoderX",
  "download.hero.title": "下載 HopCoderX",
  "download.hero.subtitle": "適用於 macOS、Windows 與 Linux 的 Beta 版現已提供",
  "download.hero.button": "下載 {{os}} 版",
  "download.section.terminal": "HopCoderX 終端",
  "download.section.desktop": "HopCoderX 桌面版（Beta）",
  "download.section.extensions": "HopCoderX 擴充功能",
  "download.section.integrations": "HopCoderX 整合",
  ...
  "download.faq.a3.beforeLocal":
    "不一定，但很可能需要。如果你想將 HopCoderX 連接到付費供應商，你需要 AI 訂閱，不過你也可以使用",
  "download.faq.a3.localLink": "本地模型",
  "download.faq.a3.afterLocal.beforeBdr": "免費。我們也推薦使用",
  "download.faq.a3.afterBdr": "，但 HopCoderX 同樣支援 OpenAI、Anthropic、xAI 等所有主流供應商。",

  "download.faq.a5.p1": "HopCoderX 100% 免費使用。",
  "download.faq.a5.p2.beforeBdr": "額外費用來自你對模型供應商的訂閱。雖然 HopCoderX 支援任何模型供應商，但我們建議使用",
  "download.faq.a5.p2.afterBdr": "。",

  "download.faq.a6.p1": "你的資料與資訊只會在你於 HopCoderX 中建立可分享連結時被儲存。",
  "download.faq.a6.p2.beforeShare": "了解更多關於",
  "download.faq.a6.shareLink": "分享頁面",

  "enterprise.title": "HopCoderX | 面向組織的企業解決方案",
  "enterprise.meta.description": "聯絡 HopCoderX 取得企業解決方案",
  "enterprise.hero.title": "你的程式碼屬於你",
  "enterprise.hero.body1":
    "HopCoderX 在你的組織內部安全運作，不會儲存任何資料或上下文，也沒有授權限制或所有權主張。你可以先與團隊進行試用，然後透過與你的 SSO 與內部 AI 閘道器整合，將其部署到整個組織。",
  ...
  "enterprise.faq.q1": "什麼是 HopCoderX Enterprise？",
  "enterprise.faq.a1":
    "HopCoderX Enterprise 適用於希望確保程式碼與資料絕不離開自己基礎設施的組織。透過中央化設定，它可與你的 SSO 與內部 AI 閘道器整合，以達成此目標。",
  "enterprise.faq.q2": "如何開始使用 HopCoderX Enterprise？",
  "enterprise.faq.a2":
    "只要先以團隊的內部試用開始。HopCoderX 預設不會儲存你的程式碼或上下文資料，所以上手非常容易。之後聯絡我們，討論定價與完整實作方案。",
  "enterprise.faq.q3": "企業定價是如何進行的？",
  "enterprise.faq.a3":
    "我們提供按席位的企業定價。如果你有自己的 LLM 閘道器，我們不會對使用的 token 另外收費。更多詳情，請聯絡我們以獲得依據組織需求的客製報價。",
  "enterprise.faq.q4": "我的資料在 HopCoderX Enterprise 中是安全的嗎？",
  "enterprise.faq.a4":
    "是的。HopCoderX 不會儲存你的程式碼或上下文資料。所有處理都會在本地或透過直接呼叫你的 AI 供應商 API 完成。透過中央化設定與 SSO 整合，你的資料會安全保留在組織的基礎設施內部。",

  "brand.title": "HopCoderX | 品牌",
  "brand.meta.description": "HopCoderX 品牌指南",
  "brand.heading": "品牌指南",
  "brand.subtitle": "協助你使用 HopCoderX 品牌的資源與素材。",
  "brand.downloadAll": "下載所有素材",

  "changelog.title": "HopCoderX | 更新日誌",
  "changelog.meta.description": "HopCoderX 發布說明與更新日誌",
  "changelog.hero.title": "更新日誌",
  "changelog.hero.subtitle": "HopCoderX 的新更新與改善",
