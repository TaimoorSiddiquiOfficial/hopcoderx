...
export const dict = {
  ...
  "temp.feature.zen.afterLink": "由 HopCoderX 提供",
  ...
  "home.faq.a3.p3": "我們鼓勵使用 Zen，但 HopCoderX 也支援 OpenAI、Anthropic、xAI 等主流供應商。",
  ...
  "home.zenCta.body":
    "Zen 提供一組精選的 AI 模型，這些模型是 HopCoderX 為了編碼代理專門測試與評測過的。無需擔心不同供應商之間效能與品質參差不齊，使用經過驗證的模型即可。",
  "home.zenCta.link": "了解 Zen",

  "zen.title": "HopCoderX Zen | 專為編碼代理精選的可靠最佳化模型",
  "zen.hero.title": "專為編碼代理提供的可靠最佳化模型",
  "zen.hero.body":
    "Zen 提供一組精選的 AI 模型，這些模型是 HopCoderX 為了編碼代理專門測試與評測過的。無需擔心效能與品質參差不齊，使用經過驗證的模型即可。",

  "zen.faq.q1": "什麼是 HopCoderX Zen？",
  "zen.faq.a1": "Zen 是由 HopCoderX 團隊打造、專為編碼代理測試與評測的 AI 模型精選集合。",
  "zen.faq.q2": "是什麼讓 Zen 更準確？",
  "zen.faq.a2": "Zen 只提供專為編碼代理測試與評測的模型。你不會用奶油刀切牛排，也別用糟糕的模型來寫程式。",
  "zen.faq.q3": "Zen 更便宜嗎？",
  "zen.faq.a3":
    "Zen 不以營利為目的。Zen 會把模型供應商的成本原樣轉給你。Zen 的使用量越高，HopCoderX 就越能談到更好的價格並把優惠讓利給你。",
  ...
  "zen.faq.a4.p3": "為了覆蓋成本，HopCoderX 只會收取很小的支付處理費：每次儲值 $20 會額外收取 $1.23。",
  "zen.faq.q5": "資料與隱私如何？",
  ...
  "zen.faq.a8":
    "Zen 與 HopCoderX 搭配得很好，但你也可以在任何代理中使用 Zen。請在你偏好的編碼代理中按照設定說明進行配置。",
  ...
  "zen.problem.subtitle": "我們正在為所有人解決此問題，而不僅僅是 HopCoderX 使用者。",
  ...
  "zen.how.body": "雖然我們建議你將 Zen 與 HopCoderX 一起使用，但你可以將 Zen 與任何代理一起使用。",
  ...
  "workspace.newUser.feature.lockin.body":
    "將 Zen 與任何編碼代理結合使用，並在需要時隨時使用 HopCoderX 連接其他供應商。",
  ...
  "download.faq.a3.afterZen": "，但 HopCoderX 同樣支援 OpenAI、Anthropic、xAI 等所有主流供應商。",

  "download.faq.a5.p1": "HopCoderX 100% 免費使用。",
  "download.faq.a5.p2.beforeZen": "額外費用來自你對模型供應商的訂閱。雖然 HopCoderX 支援任何模型供應商，但我們建議使用",
