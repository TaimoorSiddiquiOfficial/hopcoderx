...
export const dict = {
  ...
  "notFound.title": "ไม่พบหน้า | HopCoderX",
  ...
  "home.title": "HopCoderX | เอเจนต์เขียนโค้ดด้วย AI แบบโอเพนซอร์ส",

  "temp.title": "HopCoderX | เอเจนต์เขียนโค้ด AI ที่สร้างมาเพื่อเทอร์มินัล",
  ...
  "temp.feature.bdr.link": "รายการโมเดลที่คัดสรรแล้ว",
  "temp.feature.bdr.afterLink": "โดย HopCoderX",
  "temp.feature.models.beforeLink": "รองรับผู้ให้บริการ LLM กว่า 75 รายผ่าน",
  "temp.feature.models.afterLink": "รวมถึงโมเดล Local",
  "temp.screenshot.caption": "HopCoderX TUI พร้อมธีม tokyonight",
  "temp.screenshot.alt": "HopCoderX TUI พร้อมธีม tokyonight",
  ...
  "home.what.title": "HopCoderX คืออะไร?",
  "home.what.body": "HopCoderX คือเอเจนต์โอเพนซอร์สที่ช่วยคุณเขียนโค้ดในเทอร์มินัล, IDE หรือเดสก์ท็อป",
  ...
  "home.growth.body":
    "ด้วยยอดดาวบน GitHub กว่า <strong>{{stars}}</strong> ดวง, ผู้ร่วมพัฒนา <strong>{{contributors}}</strong> คน, และการคอมมิตกว่า <strong>{{commits}}</strong> ครั้ง, HopCoderX ได้รับความไว้วางใจจากนักพัฒนากว่า <strong>{{monthlyUsers}}</strong> คนในทุกเดือน",
  ...
  "home.privacy.body":
    "HopCoderX ไม่จัดเก็บโค้ดหรือข้อมูลบริบทของคุณ เพื่อให้สามารถทำงานในสภาพแวดล้อมที่ให้ความสำคัญกับความเป็นส่วนตัวได้",
  "home.privacy.learnMore": "เรียนรู้เพิ่มเติมเกี่ยวกับ",
  "home.privacy.link": "ความเป็นส่วนตัว",

  "home.faq.q1": "HopCoderX คืออะไร?",
  "home.faq.a1":
    "HopCoderX เป็นเอเจนต์โอเพนซอร์สที่ช่วยให้คุณเขียนและรันโค้ดด้วยโมเดล AI ใดก็ได้ มีให้เลือกใช้ทั้งแบบอินเทอร์เฟซเทอร์มินัล, แอปเดสก์ท็อป หรือส่วนขยาย IDE",
  "home.faq.q2": "ฉันจะเริ่มใช้ HopCoderX ได้อย่างไร?",
  "home.faq.a2.before": "วิธีเริ่มต้นที่ง่ายที่สุดคืออ่าน",
  "home.faq.a2.link": "บทนำ",
  "home.faq.q3": "ต้องสมัครสมาชิก AI เพิ่มเติมเพื่อใช้ HopCoderX หรือไม่?",
  "home.faq.a3.p1": "ไม่จำเป็นเสมอไป HopCoderX มาพร้อมกับชุดโมเดลฟรีที่คุณสามารถใช้ได้โดยไม่ต้องสร้างบัญชี",
  "home.faq.a3.p2.beforeBdr": "นอกจากนี้ คุณสามารถใช้โมเดลยอดนิยมใดก็ได้โดยการสร้างบัญชี",
  "home.faq.a3.p2.afterBdr": "",
  "home.faq.a3.p3":
    "แม้เราจะแนะนำให้ใช้ Bdr แต่ HopCoderX ก็ทำงานร่วมกับผู้ให้บริการยอดนิยมทั้งหมด เช่น OpenAI, Anthropic, xAI เป็นต้น",
  "home.faq.a3.p4.beforeLocal": "คุณยังสามารถเชื่อมต่อกับ",
  "home.faq.a3.p4.localLink": "โมเดล Local ของคุณ",
  "home.faq.q4": "ฉันสามารถใช้การสมัครสมาชิก AI ที่มีอยู่กับ HopCoderX ได้หรือไม่?",
  "home.faq.a4.p1":
    "ได้ HopCoderX รองรับแผนการสมัครสมาชิกจากผู้ให้บริการหลักทั้งหมด คุณสามารถใช้การสมัครสมาชิก Claude Pro/Max, ChatGPT Plus/Pro หรือ GitHub Copilot ของคุณได้",
  "home.faq.q5": "ฉันใช้ HopCoderX ได้เฉพาะในเทอร์มินัลใช่หรือไม่?",
  "home.faq.a5.beforeDesktop": "ไม่อีกต่อไป! HopCoderX มีแอปสำหรับ",
  "home.faq.a5.desktop": "เดสก์ท็อป",
  "home.faq.a5.and": "และ",
  "home.faq.a5.web": "เว็บ",
  "home.faq.q6": "HopCoderX ราคาเท่าไหร่?",
  "home.faq.a6":
    "HopCoderX ใช้งานได้ฟรี 100% และมาพร้อมกับชุดโมเดลฟรี อาจมีค่าใช้จ่ายเพิ่มเติมหากคุณเชื่อมต่อกับผู้ให้บริการรายอื่น",
  ...
  "home.faq.q8": "HopCoderX เป็นโอเพนซอร์สหรือไม่?",
  "home.faq.a8.p1": "ใช่ HopCoderX เป็นโอเพนซอร์สเต็มรูปแบบ ซอร์สโค้ดเปิดเผยต่อสาธารณะบน",
  ...
  "home.bdrCta.title": "เข้าถึงโมเดลที่เชื่อถือได้และปรับแต่งมาแล้วสำหรับเอเจนต์เขียนโค้ด",
  "home.bdrCta.body":
    "Bdr ให้คุณเข้าถึงชุดโมเดล AI ที่คัดสรรมาแล้ว ซึ่ง HopCoderX ได้ทดสอบและทำเบนช์มาร์กโดยเฉพาะสำหรับเอเจนต์เขียนโค้ด ไม่ต้องกังวลเรื่องประสิทธิภาพและคุณภาพที่ไม่สม่ำเสมอจากผู้ให้บริการ ใช้โมเดลที่ผ่านการตรวจสอบแล้วว่าใช้งานได้จริง",
  "home.bdrCta.link": "เรียนรู้เกี่ยวกับ Bdr",

  "bdr.title": "HopCoderX Bdr | ชุดโมเดลที่คัดสรรมาอย่างดี เชื่อถือได้ และปรับแต่งแล้วสำหรับเอเจนต์เขียนโค้ด",
  "bdr.hero.title": "โมเดลที่ปรับแต่งมาอย่างดีและเชื่อถือได้สำหรับเอเจนต์เขียนโค้ด",
  "bdr.hero.body":
    "Bdr ให้คุณเข้าถึงชุดโมเดล AI ที่คัดสรรมาแล้ว ซึ่ง HopCoderX ได้ทดสอบและทำเบนช์มาร์กโดยเฉพาะสำหรับเอเจนต์เขียนโค้ด ไม่ต้องกังวลเรื่องประสิทธิภาพและคุณภาพที่ไม่สม่ำเสมอ ใช้โมเดลที่ผ่านการตรวจสอบแล้วว่าใช้งานได้จริง",

  "bdr.faq.q1": "HopCoderX Bdr คืออะไร?",
  "bdr.faq.a1":
    "Bdr คือชุดโมเดล AI ที่คัดสรรมาอย่างดี ผ่านการทดสอบและทำเบนช์มาร์กสำหรับเอเจนต์เขียนโค้ด สร้างโดยทีมงานผู้อยู่เบื้องหลัง HopCoderX",
  "bdr.faq.q2": "อะไรทำให้ Bdr แม่นยำกว่า?",
  "bdr.faq.a2":
    "Bdr ให้บริการเฉพาะโมเดลที่ได้รับการทดสอบและทำเบนช์มาร์กสำหรับเอเจนต์เขียนโค้ดโดยเฉพาะ คุณคงไม่ใช้มีดทาเนยมาหั่นสเต็ก ดังนั้นอย่าใช้โมเดลคุณภาพต่ำสำหรับการเขียนโค้ด",
  "bdr.faq.q3": "Bdr ราคาถูกกว่าหรือไม่?",
  "bdr.faq.a3":
    "Bdr ไม่ได้แสวงหากำไร Bdr ส่งผ่านต้นทุนจากผู้ให้บริการโมเดลมาถึงคุณ ยิ่งมีการใช้งาน Bdr มากเท่าไหร่ HopCoderX ก็ยิ่งสามารถต่อรองเรตราคาที่ดีกว่าและส่งต่อให้คุณได้มากขึ้นเท่านั้น",
  "bdr.faq.q4": "Bdr ราคาเท่าไหร่?",
  "bdr.faq.a4.p1.beforePricing": "Bdr",
  "bdr.faq.a4.p1.pricingLink": "คิดค่าบริการต่อคำขอ",
  "bdr.faq.a4.p1.afterPricing": "โดยไม่มีการบวกเพิ่ม ดังนั้นคุณจ่ายเท่ากับที่ผู้ให้บริการโมเดลเรียกเก็บ",
  "bdr.faq.a4.p2.beforeAccount":
    "ค่าใช้จ่ายรวมของคุณขึ้นอยู่กับการใช้งาน และคุณสามารถตั้งวงเงินการใช้จ่ายรายเดือนได้ใน",
  "bdr.faq.a4.p2.accountLink": "บัญชีของคุณ",
  "bdr.faq.a4.p3":
    "เพื่อครอบคลุมต้นทุน HopCoderX คิดค่าธรรมเนียมการประมวลผลการชำระเงินเพียงเล็กน้อย $1.23 ต่อการเติมเงิน $20",
  "bdr.faq.q5": "แล้วเรื่องข้อมูลและความเป็นส่วนตัวล่ะ?",
  "bdr.faq.a5.beforeExceptions":
    "โมเดล Bdr ทั้งหมดโฮสต์ในสหรัฐอเมริกา ผู้ให้บริการปฏิบัติตามนโยบายไม่เก็บรักษาข้อมูล (zero-retention policy) และไม่ใช้ข้อมูลของคุณสำหรับการฝึกโมเดล โดยมี",
  "bdr.faq.a5.exceptionsLink": "ข้อยกเว้นดังนี้",
  "bdr.faq.q6": "ฉันสามารถตั้งวงเงินการใช้จ่ายได้หรือไม่?",
  "bdr.faq.a6": "ได้ คุณสามารถตั้งวงเงินการใช้จ่ายรายเดือนได้ในบัญชีของคุณ",
  "bdr.faq.q7": "ฉันสามารถยกเลิกได้หรือไม่?",
  "bdr.faq.a7": "ได้ คุณสามารถปิดการเรียกเก็บเงินได้ตลอดเวลาและใช้ยอดเงินคงเหลือของคุณจนหมด",
  "bdr.faq.q8": "ฉันสามารถใช้ Bdr กับเอเจนต์เขียนโค้ดอื่นได้หรือไม่?",
  "bdr.faq.a8":
    "แม้ว่า Bdr จะทำงานได้ดีเยี่ยมกับ HopCoderX แต่คุณสามารถใช้ Bdr กับเอเจนต์ใดก็ได้ เพียงทำตามคำแนะนำการตั้งค่าในเอเจนต์เขียนโค้ดที่คุณต้องการ",

  "bdr.cta.start": "เริ่มต้นใช้งาน Bdr",
  "bdr.pricing.title": "เติมเงิน $20 แบบ Pay as you go",
  "bdr.pricing.fee": "(+ค่าธรรมเนียมประมวลผลบัตร $1.23)",
  "bdr.pricing.body": "ใช้ได้กับทุกเอเจนต์ ตั้งวงเงินรายเดือนได้ ยกเลิกได้ตลอดเวลา",
  "bdr.problem.title": "Bdr กำลังแก้ปัญหาอะไร?",
  "bdr.problem.body":
  ...
  "bdr.problem.subtitle": "เรากำลังแก้ไขปัญหานี้สำหรับทุกคน ไม่ใช่แค่ผู้ใช้ HopCoderX เท่านั้น",
  "bdr.problem.item1": "ทดสอบโมเดลที่คัดเลือกมาและปรึกษากับทีมของโมเดลนั้นๆ",
  "bdr.problem.item2": "ทำงานร่วมกับผู้ให้บริการเพื่อให้มั่นใจว่าโมเดลถูกส่งมอบอย่างถูกต้อง",
  "bdr.problem.item3": "ทำเบนช์มาร์กทุกการจับคู่ระหว่างโมเดลและผู้ให้บริการที่เราแนะนำ",
  "bdr.how.title": "Bdr ทำงานอย่างไร",
  "bdr.how.body": "แม้เราจะแนะนำให้คุณใช้ Bdr กับ HopCoderX แต่คุณสามารถใช้ Bdr กับเอเจนต์ใดก็ได้",
  "bdr.how.step1.title": "ลงทะเบียนและเติมเงิน $20",
  "bdr.how.step1.beforeLink": "ทำตาม",
  "bdr.how.step1.link": "คำแนะนำการตั้งค่า",
  "bdr.how.step2.title": "ใช้ Bdr ด้วยราคาที่โปร่งใส",
  "bdr.how.step2.link": "จ่ายตามคำขอ (pay per request)",
  "bdr.how.step2.afterLink": "โดยไม่มีการบวกเพิ่ม",
  "bdr.how.step3.title": "เติมเงินอัตโนมัติ",
  "bdr.how.step3.body": "เมื่อยอดเงินของคุณเหลือ $5 เราจะเติมเงิน $20 ให้โดยอัตโนมัติ",
  "bdr.privacy.title": "ความเป็นส่วนตัวของคุณสำคัญสำหรับเรา",
  "bdr.privacy.beforeExceptions":
    "โมเดล Bdr ทั้งหมดโฮสต์ในสหรัฐอเมริกา ผู้ให้บริการปฏิบัติตามนโยบายไม่เก็บรักษาข้อมูล (zero-retention policy) และไม่ใช้ข้อมูลของคุณสำหรับการฝึกโมเดล โดยมี",
  "bdr.privacy.exceptionsLink": "ข้อยกเว้นดังนี้",

  "black.meta.title": "HopCoderX Black | เข้าถึงโมเดลเขียนโค้ดที่ดีที่สุดในโลก",
  "black.meta.description": "เข้าถึง Claude, GPT, Gemini และอื่นๆ ด้วยแผนสมาชิก HopCoderX Black",
  "black.hero.title": "เข้าถึงโมเดลเขียนโค้ดที่ดีที่สุดในโลก",
  "black.hero.subtitle": "รวมถึง Claude, GPT, Gemini และอื่นๆ อีกมากมาย",
  "black.title": "HopCoderX Black | ราคา",
  ...
  "black.workspace.title": "HopCoderX Black | เลือก Workspace",
  "black.workspace.selectPlan": "เลือก Workspace สำหรับแผนนี้",
  "black.workspace.name": "Workspace {{n}}",
  "black.subscribe.title": "สมัครสมาชิก HopCoderX Black",
  ...
  "black.subscribe.success.title": "คุณอยู่ในรายชื่อรอ HopCoderX Black แล้ว",
  ...
  "workspace.newUser.feature.lockin.body":
    "ใช้ Bdr กับเอเจนต์เขียนโค้ดใดก็ได้ และกลับมาใช้ผู้ให้บริการรายอื่นด้วย HopCoderX ได้ทุกเมื่อที่คุณต้องการ",
  ...
  "workspace.newUser.step.login.after": "และเลือก HopCoderX",
  "workspace.newUser.step.pasteKey": "วาง API key ของคุณ",
  "workspace.newUser.step.models.before": "เริ่ม HopCoderX และรัน",
  ...
  "workspace.keys.subtitle": "จัดการ API keys ของคุณสำหรับการเข้าถึงบริการ HopCoderX",
  "workspace.keys.create": "สร้าง API Key",
  "workspace.keys.placeholder": "ป้อนชื่อ Key",
  "workspace.keys.empty": "สร้าง HopCoderX Gateway API key",
  ...
  "workspace.black.subscription.message": "คุณสมัครสมาชิก HopCoderX Black ในราคา ${{plan}} ต่อเดือน",
  ...
  "workspace.black.waitlist.joined": "คุณอยู่ในรายชื่อรอสำหรับแผน HopCoderX Black ราคา ${{plan}} ต่อเดือน",
  "workspace.black.waitlist.ready": "เราพร้อมที่จะลงทะเบียนให้คุณเข้าสู่แผน HopCoderX Black ราคา ${{plan}} ต่อเดือนแล้ว",
  ...
  "download.title": "HopCoderX | ดาวน์โหลด",
  "download.meta.description": "ดาวน์โหลด HopCoderX สำหรับ macOS, Windows และ Linux",
  "download.hero.title": "ดาวน์โหลด HopCoderX",
  ...
  "download.section.extensions": "ส่วนขยาย HopCoderX",
  "download.section.integrations": "การเชื่อมต่อ HopCoderX",
  ...
  "download.faq.a3.beforeLocal":
    "ไม่จำเป็นเสมอไป แต่อาจจะต้องมี คุณจะต้องมีการสมัครสมาชิก AI หากต้องการเชื่อมต่อ HopCoderX กับผู้ให้บริการที่มีค่าใช้จ่าย แม้ว่าคุณจะสามารถทำงานกับ",
  "download.faq.a3.localLink": "โมเดล Local",
  "download.faq.a3.afterLocal.beforeBdr": "ได้ฟรี แม้ว่าเราจะแนะนำให้ผู้ใช้ใช้งาน",
  "download.faq.a3.afterBdr": ", HopCoderX ก็ทำงานร่วมกับผู้ให้บริการยอดนิยมทั้งหมด เช่น OpenAI, Anthropic, xAI เป็นต้น",

  "download.faq.a5.p1": "HopCoderX ใช้งานได้ฟรี 100%",
  "download.faq.a5.p2.beforeBdr":
    "ค่าใช้จ่ายเพิ่มเติมใดๆ จะมาจากการสมัครสมาชิกของคุณกับผู้ให้บริการโมเดล แม้ว่า HopCoderX จะทำงานร่วมกับผู้ให้บริการโมเดลใดก็ได้ แต่เราแนะนำให้ใช้",
  "download.faq.a5.p2.afterBdr": "",

  "download.faq.a6.p1": "ข้อมูลของคุณจะถูกจัดเก็บเฉพาะเมื่อคุณสร้างลิงก์ที่แชร์ได้ใน HopCoderX เท่านั้น",
  "download.faq.a6.p2.beforeShare": "เรียนรู้เพิ่มเติมเกี่ยวกับ",
  "download.faq.a6.shareLink": "หน้าแชร์",

  "enterprise.title": "HopCoderX | โซลูชันระดับองค์กรสำหรับองค์กรของคุณ",
  "enterprise.meta.description": "ติดต่อ HopCoderX สำหรับโซลูชันระดับองค์กร",
  "enterprise.hero.title": "โค้ดของคุณเป็นของคุณ",
  "enterprise.hero.body1":
    "HopCoderX ทำงานอย่างปลอดภัยภายในองค์กรของคุณ โดยไม่มีการจัดเก็บข้อมูลหรือบริบท และไม่มีข้อจำกัดด้านไลเซนส์หรือการอ้างสิทธิ์ความเป็นเจ้าของ เริ่มทดลองใช้งานกับทีมของคุณ แล้วนำไปใช้งานทั่วทั้งองค์กรโดยการผสานรวมกับ SSO และ AI gateway ภายในของคุณ",
  ...
  "enterprise.faq.q1": "HopCoderX Enterprise คืออะไร?",
  "enterprise.faq.a1":
    "HopCoderX Enterprise สำหรับองค์กรที่ต้องการให้มั่นใจว่าโค้ดและข้อมูลจะไม่ออกนอกโครงสร้างพื้นฐานของตน ทำได้โดยใช้การตั้งค่าแบบศูนย์กลางที่ผสานรวมกับ SSO และ AI gateway ภายในของคุณ",
  "enterprise.faq.q2": "จะเริ่มต้นกับ HopCoderX Enterprise ได้อย่างไร?",
  "enterprise.faq.a2":
    "เพียงเริ่มจากการทดลองใช้งานภายในกับทีมของคุณ โดยค่าเริ่มต้น HopCoderX ไม่จัดเก็บโค้ดหรือข้อมูลบริบทของคุณ ทำให้เริ่มต้นได้ง่าย จากนั้นติดต่อเราเพื่อพูดคุยเรื่องราคาและตัวเลือกการติดตั้งใช้งาน",
  ...
  "enterprise.faq.q4": "ข้อมูลของฉันปลอดภัยกับ HopCoderX Enterprise หรือไม่?",
  "enterprise.faq.a4":
    "ใช่ HopCoderX ไม่จัดเก็บโค้ดหรือข้อมูลบริบทของคุณ การประมวลผลทั้งหมดเกิดขึ้นในเครื่องหรือผ่านการเรียก API โดยตรงไปยังผู้ให้บริการ AI ของคุณ ด้วยการตั้งค่าแบบศูนย์กลางและการผสานรวม SSO ข้อมูลของคุณจะยังคงปลอดภัยอยู่ภายในโครงสร้างพื้นฐานขององค์กร",

  "brand.title": "HopCoderX | แบรนด์",
  "brand.meta.description": "แนวทางการใช้แบรนด์ HopCoderX",
  "brand.heading": "แนวทางการใช้แบรนด์",
  "brand.subtitle": "ทรัพยากรและแอสเซทเพื่อช่วยให้คุณใช้งานแบรนด์ HopCoderX",
  "brand.downloadAll": "ดาวน์โหลดแอสเซททั้งหมด",

  "changelog.title": "HopCoderX | บันทึกการเปลี่ยนแปลง",
  "changelog.meta.description": "บันทึกการออกรุ่นและบันทึกการเปลี่ยนแปลง HopCoderX",
  "changelog.hero.title": "บันทึกการเปลี่ยนแปลง",
  "changelog.hero.subtitle": "การอัปเดตและการปรับปรุงใหม่ใน HopCoderX",
