...
export const dict = {
  ...
  "notFound.title": "Ikke funnet | HopCoderX",
  ...
  "home.title": "HopCoderX | Den åpne kildekode AI-kodingsagenten",
  ...
  "temp.screenshot.alt": "HopCoderX TUI med tokyonight-tema",
  ...
  "home.what.title": "Hva er HopCoderX?",
  "home.what.body": "HopCoderX er en åpen kildekode-agent som hjelper deg å skrive kode i terminal, IDE eller desktop.",
  ...
  "home.growth.body":
    "Med over <strong>{{stars}}</strong> GitHub-stjerner, <strong>{{contributors}}</strong> bidragsytere og over <strong>{{commits}}</strong> commits, brukes HopCoderX av over <strong>{{monthlyUsers}}</strong> utviklere hver måned.",
  ...
  "home.privacy.body":
    "HopCoderX lagrer ikke koden din eller kontekstdata, slik at den kan fungere i personvernsensitive miljøer.",
  "home.privacy.learnMore": "Les mer om",
  "home.privacy.link": "personvern",

  "home.faq.q1": "Hva er HopCoderX?",
  "home.faq.a1":
    "HopCoderX er en åpen kildekode-agent som hjelper deg å skrive og kjøre kode med hvilken som helst AI-modell. Den er tilgjengelig som terminalgrensesnitt, desktop-app eller IDE-utvidelse.",
  "home.faq.q2": "Hvordan bruker jeg HopCoderX?",
  ...
  "home.faq.a4.p1":
    "Ja, HopCoderX støtter abonnementer fra alle store leverandører. Du kan bruke Claude Pro/Max, ChatGPT Plus/Pro eller GitHub Copilot-abonnementer.",
  "home.faq.q5": "Kan jeg bare bruke HopCoderX i terminalen?",
  "home.faq.a5.beforeDesktop": "Ikke lenger! HopCoderX er nå tilgjengelig som en app for",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "og",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Hva koster HopCoderX?",
  "home.faq.a6":
    "HopCoderX er 100% gratis å bruke. Det kommer også med et sett gratis modeller. Det kan være ekstra kostnader hvis du kobler til en annen leverandør.",
  ...
  "home.faq.q8": "Er HopCoderX åpen kildekode?",
  "home.faq.a8.p1": "Ja, HopCoderX er fullt open source. Kildekoden er offentlig på",
  ...
  "black.workspace.title": "HopCoderX Black | Velg arbeidsområde",
  ...
  "black.subscribe.success.title": "Du er på ventelisten for HopCoderX Black",
  ...
  "workspace.newUser.step.login.after": "og velg HopCoderX",
  "workspace.newUser.step.pasteKey": "Lim inn API-nøkkelen",
  "workspace.newUser.step.models.before": "Start HopCoderX og kjør",
  ...
  "workspace.keys.subtitle": "Administrer API-nøklene dine for å få tilgang til HopCoderX-tjenester.",
  "workspace.keys.create": "Opprett API-nøkkel",
  "workspace.keys.placeholder": "Skriv inn navn på nøkkel",
  "workspace.keys.empty": "Opprett en HopCoderX Gateway API-nøkkel",
  ...
  "workspace.black.subscription.message": "Du abonnerer på HopCoderX Black for ${{plan}} per måned.",
  ...
  "workspace.black.waitlist.joined": "Du står på venteliste for HopCoderX Black-planen til ${{plan}} per måned.",
  "workspace.black.waitlist.ready": "Vi er klare til å melde deg på HopCoderX Black-planen til ${{plan}} per måned.",
  ...
  "download.title": "HopCoderX | Last ned",
  "download.meta.description": "Last ned HopCoderX for macOS, Windows og Linux",
  "download.hero.title": "Last ned HopCoderX",
  ...
  "enterprise.title": "HopCoderX | Enterprise-løsninger for din organisasjon",
  "enterprise.meta.description": "Kontakt HopCoderX for enterprise-løsninger",
  "enterprise.hero.title": "Koden din er din",
  "enterprise.hero.body1":
    "HopCoderX opererer sikkert inne i organisasjonen din uten at data eller kontekst lagres, og uten lisensbegrensninger eller eierskapskrav. Start en prøveperiode med teamet ditt, og rull den deretter ut i hele organisasjonen ved å integrere den med SSO og din interne AI-gateway.",
  ...
  "enterprise.faq.q1": "Hva er HopCoderX Enterprise?",
  "enterprise.faq.a1":
    "HopCoderX Enterprise er for organisasjoner som vil sikre at koden og dataene deres aldri forlater infrastrukturen. Dette kan gjøres med en sentral konfigurasjon som integreres med SSO og intern AI-gateway.",
  "enterprise.faq.q2": "Hvordan kommer jeg i gang med HopCoderX Enterprise?",
  "enterprise.faq.a2":
    "Start enkelt med en intern prøveperiode med teamet ditt. HopCoderX lagrer som standard ikke koden din eller kontekstdata, noe som gjør det enkelt å komme i gang. Kontakt oss deretter for å diskutere priser og implementeringsalternativer.",
  ...
  "enterprise.faq.q4": "Er dataene mine sikre med HopCoderX Enterprise?",
  "enterprise.faq.a4":
    "Ja. HopCoderX lagrer ikke koden din eller kontekstdata. All behandling skjer lokalt eller gjennom direkte API-kall til AI-leverandøren din. Med sentral konfigurasjon og SSO-integrasjon forblir dataene dine sikre innenfor organisasjonens infrastruktur.",

  "brand.title": "HopCoderX | Merkevare",
  "brand.meta.description": "HopCoderX retningslinjer for merkevare",
  "brand.heading": "Retningslinjer for merkevare",
  "brand.subtitle": "Ressurser og assets som hjelper deg å jobbe med HopCoderX-brandet.",
  "brand.downloadAll": "Last ned alle assets",

  "changelog.title": "HopCoderX | Endringslogg",
  "changelog.meta.description": "Utgivelsesnotater og endringslogg for HopCoderX",
  "changelog.hero.title": "Endringslogg",
  "changelog.hero.subtitle": "Nye oppdateringer og forbedringer for HopCoderX",
