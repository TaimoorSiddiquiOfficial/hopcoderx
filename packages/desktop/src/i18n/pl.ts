export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji HopCoderX",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} HopCoderX. Czy chcesz ją zainstalować i uruchomić ponownie?",
  ...
  "desktop.cli.installed.message":
    "CLI zainstalowane w {{path}}\n\nUruchom ponownie terminal, aby użyć polecenia 'hopcoderx'.",
