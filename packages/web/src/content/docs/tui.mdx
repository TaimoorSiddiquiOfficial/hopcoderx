---
title: TUI
description: Using the HopCoderX terminal user interface.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

HopCoderX provides an interactive terminal interface or TUI for working on your projects with an LLM.

Running HopCoderX starts the TUI for the current directory.
...
When using the HopCoderX TUI, you can type `/` followed by a command name to quickly execute actions. For example:
