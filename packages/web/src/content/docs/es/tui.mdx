---
title: TUI
description: Usando la interfaz de usuario del terminal HopCoderX.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

HopCoderX proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar HopCoderX se inicia TUI para el directorio actual.
...
Cuando utilice HopCoderX TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a HopCoderX. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Salga de HopCoderX. _Alias_: `/quit`, `/q`
...
Puede personalizar el comportamiento de TUI a través de su archivo de configuración HopCoderX.
