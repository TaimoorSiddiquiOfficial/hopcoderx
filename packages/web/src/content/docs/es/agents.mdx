...
El ID del modelo en su configuración HopCoderX usa el formato `provider/model-id`. Por ejemplo, si usa [HopCoderX Bdr](/docs/zen), usaría `HopCoderX/gpt-5.1-codex` para GPT 5.1 Codex.
