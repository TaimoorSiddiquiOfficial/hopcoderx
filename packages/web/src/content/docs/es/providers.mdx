...
HopCoderX Zen es una lista de modelos proporcionados por el equipo HopCoderX que han sido
probado y verificado para funcionar bien con HopCoderX. [Más información](/docs/zen).

:::tip
Si eres nuevo, te recomendamos comenzar con HopCoderX Zen.
:::
...
HopCoderX Zen es una lista de modelos probados y verificados proporcionada por el equipo HopCoderX. [Más información](/docs/zen).

1. Inicie sesión en **<a href={console}>HopCoderX Zen</a>** y haga clic en **Crear API clave**.

2. Ejecute el comando `/connect` y busque **HopCoderX Zen**.
