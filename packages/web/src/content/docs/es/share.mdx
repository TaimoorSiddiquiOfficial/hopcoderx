---
title: Compartir
description: Comparte tus conversaciones HopCoderX.
---

La función para compartir de HopCoderX te permite crear enlaces públicos a tus conversaciones de HopCoderX, para que puedas colaborar con compañeros de equipo u obtener ayuda de otros.
...
Cuando compartes una conversación, HopCoderX:
...
HopCoderX admite tres modos de compartir que controlan cómo se comparten las conversaciones:

---

### Manual (predeterminado)

De forma predeterminada, HopCoderX usa el modo de compartir manual. Las sesiones no se comparten automáticamente, pero puedes compartirlas manualmente usando el comando `/share`:
...
Para aplicar esto en todo su equipo para un proyecto determinado, agréguelo al `HopCoderX.json` en su proyecto y regístrelo en Git.
...
[Obtenga más información](/docs/enterprise) sobre el uso de HopCoderX en su organización.
