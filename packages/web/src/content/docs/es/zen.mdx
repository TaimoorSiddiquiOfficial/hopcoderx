...
HopCoderX Zen es una lista de modelos probados y verificados proporcionada por el equipo HopCoderX.

:::note
HopCoderX Zen se encuentra actualmente en versión beta.
:::

Zen funciona como cualquier otro proveedor en HopCoderX. Inicias sesion en HopCoderX Zen y obtienes
...
HopCoderX Zen es una puerta de enlace de IA que le brinda acceso a estos modelos.

---

## Cómo funciona

HopCoderX Zen funciona como cualquier otro proveedor en HopCoderX.

1. Inicias sesión en **<a href={console}>HopCoderX Zen</a>**, agregas tu facturación
   detalles y copie su clave API.
2. Ejecuta el comando `/connect` en TUI, selecciona HopCoderX Zen y pega tu clave API.
