...
Crear `.HopCoderX/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración HopCoderX o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su HopCoderX [config](/docs/config):
...
- Por proyecto: `.HopCoderX/commands/`
...
HopCoderX incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
