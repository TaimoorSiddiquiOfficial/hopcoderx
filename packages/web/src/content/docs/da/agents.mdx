...
Model-id'et i din HopCoderX-konfiguration brugerformatet `provider/model-id`. For eksempel, hvis du bruger [HopCoderX Bdr](/docs/bdr), vil du bruge `HopCoderX/gpt-5.1-codex` til GPT 5.1 Codex.
