...
HopCoderX Zen er en liste over modeller leveret af HopCoderX-teamet, som er blevet testet og verificeret til at fungere godt med HopCoderX. [Læs mere](/docs/zen).

:::tip
Hvis du er ny, anbefaler vi at starte med HopCoderX Zen.
:::

1. Kør kommandoen `/connect` i TUI, vælg HopCoderX og gå til [HopCoderX.ai/auth](https://HopCoderX.ai/auth).
...
HopCoderX Zen er en liste over testede og verificerede modeller leveret af HopCoderX-teamet. [Læs mere](/docs/zen).

1. Log på **<a href={console}>HopCoderX Zen</a>** og klik på **Create API Key**.

2. Kør kommandoen `/connect` og søg efter **HopCoderX Zen**.
