...
HopCoderX Zen er en liste over testede og verificerede modeller leveret af HopCoderX-teamet.

:::note
HopCoderX Zen er i øjeblikket i beta.
:::

Zen fungerer som alle andre udbydere i HopCoderX. Du logger på HopCoderX Zen og får
...
HopCoderX Zen er en AI gateway, der giver dig adgang til disse modeller.

---

## Sådan fungerer det

HopCoderX Zen fungerer som alle andre udbydere i HopCoderX.

1. Du logger på **<a href={console}>HopCoderX Zen</a>**, tilføjer faktureringsoplysninger
   og kopierer API-nøglen.
2. Du kører kommandoen `/connect` i TUI, vælger HopCoderX Zen og indsætter API-nøglen.
...
Vi oprettede HopCoderX Zen for at:
