---
title: TUI
description: Brug af HopCoderX-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

HopCoderX giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre HopCoderX starter TUI for den nuværende mappe.
...
Når du bruger HopCoderX TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til HopCoderX. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut HopCoderX. _Aliaser_: `/quit`, `/q`
...
Du kan tilpasse TUI-adfærden gennem HopCoderX-konfigurationsfilen.
