...
Brug den til at bygge integrasjoner og kontrollere HopCoderX programmatisk.
...
Opret en forekomst av HopCoderX:
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `HopCoderX.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av HopCoderX, kan du oprete en klientforekomst for at koble til den:
