...
HopCoderX Zen er en liste over modeller levert av HopCoderX-teamet som har vært
testet og verifisert for å fungere godt med HopCoderX. [Finn ut mer](/docs/zen).

:::tip
Hvis du er ny, anbefaler vi å starte med HopCoderX Zen.
:::
...
HopCoderX Zen er en liste over testede og verifiserte modeller levert av HopCoderX-teamet. [Finn ut mer](/docs/zen).

1. Logg på **<a href={console}>HopCoderX Zen</a>** og klikk på **Create API Key**.

2. Kjør kommandoen `/connect` og søk etter **HopCoderX Zen**.
