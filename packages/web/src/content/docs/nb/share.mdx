---
title: Deling
description: Del dine HopCoderX-samtaler.
---

Delingsfunksjonen i HopCoderX lar deg lage offentlige lenker til dine HopCoderX-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
...
Når du deler en samtale, HopCoderX:
...
HopCoderX støtter tre delingsmoduser som kontrollerer hvordan samtaler deles:

---

### Manuell (standard)

Som standard bruker HopCoderX manuell delingsmodus. Økter deles ikke automatisk, men du kan dele dem manuelt ved å bruke kommandoen `/share`:
...
For å håndheve dette på tvers av teamet ditt for et gitt prosjekt, legg det til `HopCoderX.json` i prosjektet ditt og sjekk det inn i Git.
...
[Finn ut mer](/docs/enterprise) om bruk av HopCoderX i organisasjonen din.
