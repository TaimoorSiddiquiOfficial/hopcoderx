---
title: TUI
description: Bruke HopCoderX-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

HopCoderX gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre HopCoderX starter TUI for gjeldende katalog.
...
Når du bruker HopCoderX TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til HopCoderX. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt HopCoderX. _Aliaser_: `/quit`, `/q`
...
Du kan tilpasse TUI-oppførselen gjennom HopCoderX-konfigurasjonsfilen.
