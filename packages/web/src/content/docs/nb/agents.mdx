...
Modellen ID i HopCoderX-konfigurasjonen din bruker formatet `provider/model-id`. For eksempel, hvis du bruker [HopCoderX Zen](/docs/zen), vil du bruke `HopCoderX/gpt-5.1-codex` for GPT 5.1 Codex.
