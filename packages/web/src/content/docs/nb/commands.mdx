...
Opprett `.HopCoderX/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom HopCoderX-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i HopCoderX [config](/docs/config):
...
- Per prosjekt: `.HopCoderX/commands/`
...
HopCoderX inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
