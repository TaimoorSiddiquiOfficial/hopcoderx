...
description: Lag verktøy som LLM kan kalle inn HopCoderX.
---

Egendefinerte verktøy er funksjoner du oppretter som LLM kan kalle under samtaler. De fungerer sammen med HopCoderX sine [innebygde verktøy](/docs/tools) som `read`, `write` og `bash`.
...
- Lokalt ved å plassere dem i `.HopCoderX/tools/`-katalogen til prosjektet ditt.
- Eller globalt, ved å plassere dem i `~/.config/HopCoderX/tools/`.
