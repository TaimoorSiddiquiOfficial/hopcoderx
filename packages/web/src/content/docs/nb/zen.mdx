...
HopCoderX Zen er en liste over testede og verifiserte modeller levert av HopCoderX-teamet.

:::note
HopCoderX Zen er for øyeblikket i beta.
:::

Zen fungerer som alle andre leverandører i HopCoderX. Du logger på HopCoderX Zen og får
...
HopCoderX Zen er en AI gateway som gir deg tilgang til disse modellene.

---

## Slik fungerer det

HopCoderX Zen fungerer som alle andre leverandører i HopCoderX.

1. Du logger på **<a href={console}>HopCoderX Zen</a>**, legg til fakturering
   detaljer, og kopier API-nøkkelen.
2. Du kjører kommandoen `/connect` i TUI, velger HopCoderX Zen og limer inn API-nøkkelen.
...
Vi opprettet HopCoderX Zen for å:
