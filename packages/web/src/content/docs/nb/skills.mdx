...
Agentferdigheter lar HopCoderX oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går HopCoderX opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
HopCoderX viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `HopCoderX.json`:
