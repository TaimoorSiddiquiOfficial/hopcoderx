---
title: Teilen
description: Teile HopCoderX-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu HopCoderX-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht HopCoderX Folgendes:
...
HopCoderX hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt HopCoderX den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`HopCoderX.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du HopCoderX in deiner Organisation einsetzt.
