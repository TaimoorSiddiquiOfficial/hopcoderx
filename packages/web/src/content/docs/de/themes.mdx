...
Mit HopCoderX kannst du ein eingebautes Theme waehlen, ein an dein Terminal angepasstes Theme nutzen oder ein eigenes Theme definieren.

Standardmaessig verwendet HopCoderX das `HopCoderX`-Theme.
...
HopCoderX liefert mehrere eingebaute Themes mit.
...
- HopCoderX optisch ans Terminal anpassen wollen
...
HopCoderX unterstuetzt ein flexibles JSON-basiertes Theme-System.
