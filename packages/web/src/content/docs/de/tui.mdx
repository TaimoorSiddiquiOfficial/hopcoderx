---
title: TUI
description: Arbeite mit HopCoderX in der Terminal-Oberflaeche.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

HopCoderX bietet eine interaktive Terminaloberflaeche (TUI), um mit einem LLM an deinen Projekten zu arbeiten.

Ohne weitere Argumente startet HopCoderX die TUI im aktuellen Verzeichnis.
...
In der HopCoderX-TUI kannst du `/` plus Befehlsnamen eingeben, um Aktionen schnell auszufuehren.
Zum Beispiel:
...
Add a provider to HopCoderX. Allows you to select from available providers and add their API keys.
...
Exit HopCoderX. _Aliases_: `/quit`, `/q`
...
You can customize TUI behavior through your HopCoderX config file.
