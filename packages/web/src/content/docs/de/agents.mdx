...
Die Modell-ID in Ihrer HopCoderX-Konfiguration verwendet das Format `provider/model-id`. Wenn Sie beispielsweise [HopCoderX Zen](/docs/zen) verwenden, würden Sie `HopCoderX/gpt-5.1-codex` für GPT 5.1 Codex verwenden.
