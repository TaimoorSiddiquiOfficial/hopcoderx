...
HopCoderX Zen ist eine vom HopCoderX-Team getestete und verifizierte Modellliste.

:::note
HopCoderX Zen befindet sich aktuell in der Beta.
:::

Zen funktioniert wie jeder andere Provider in HopCoderX.
Du meldest dich bei HopCoderX Zen an, holst dir deinen API-Key und nutzt ihn optional.
...
HopCoderX Zen ist ein AI-Gateway, das dir Zugriff auf genau diese Modelle gibt.

---

## Funktionsweise

HopCoderX Zen funktioniert wie jeder andere Provider in HopCoderX.

1. Melde dich bei **<a href={console}>HopCoderX Zen</a>** an, hinterlege Zahlungsdaten und kopiere deinen API-Key.
2. Fuehre in der TUI `/connect` aus, waehle HopCoderX Zen und fuege den API-Key ein.
...
Wir haben HopCoderX Zen entwickelt, um:
