...
HopCoderX verfügt über eine Liste von Tastenkombinationen, die Sie über die HopCoderX-Konfiguration anpassen können.
...
HopCoderX verwendet für die meisten Keybinds einen `leader`-Schlüssel. Dies vermeidet Konflikte in Ihrem Terminal.
...
Die Eingabeaufforderungseingabe der HopCoderX-Desktop-App unterstützt gängige Readline/Emacs-style-Verknüpfungen zum Bearbeiten von Text. Diese sind integriert und derzeit nicht über `HopCoderX.json` konfigurierbar.
