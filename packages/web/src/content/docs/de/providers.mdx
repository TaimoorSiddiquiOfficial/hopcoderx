...
HopCoderX Zen ist eine Liste von Modellen, die vom HopCoderX-Team bereitgestellt wurden
Getestet und verifiziert, dass es gut mit HopCoderX funktioniert. [Learn more](/docs/zen).

:::tip
Wenn Sie neu sind, empfehlen wir Ihnen, mit HopCoderX Zen zu beginnen.
:::

1. Führen Sie den Befehl `/connect` in TUI aus, wählen Sie HopCoderX aus und gehen Sie zu [HopCoderX.ai/auth](https://HopCoderX.ai/auth).
...
HopCoderX Zen ist eine Liste getesteter und verifizierter Modelle, die vom HopCoderX-Team bereitgestellt werden. [Learn more](/docs/zen).

1. Melden Sie sich bei **<a href={console}>HopCoderX Zen</a>** an und klicken Sie auf **Create API Key**.

2. Führen Sie den Befehl `/connect` aus und suchen Sie nach **HopCoderX Zen**.
