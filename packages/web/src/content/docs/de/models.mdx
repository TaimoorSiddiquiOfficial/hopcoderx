...
Hier ist der vollständige ID `provider_id/model_id`. Wenn Sie beispielsweise [HopCoderX Zen](/docs/zen) verwenden, würden Sie `HopCoderX/gpt-5.1-codex` für GPT 5.1 Codex verwenden.
