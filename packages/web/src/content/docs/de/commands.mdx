...
Erstellen Sie `.HopCoderX/commands/test.md`:

```md title=".HopCoderX/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die HopCoderX-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem HopCoderX [config](/docs/config):

```json title="HopCoderX.jsonc" {4-12}
{
...
- Global: `~/.config/HopCoderX/commands/`
- Pro Projekt: `.HopCoderX/commands/`

```markdown title="~/.config/HopCoderX/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".HopCoderX/commands/component.md"
---
...
```md title=".HopCoderX/commands/create-file.md"
---
...
```md title=".HopCoderX/commands/analyze-coverage.md"
---
...
```md title=".HopCoderX/commands/review-changes.md"
---
...
```md title=".HopCoderX/commands/review-component.md"
---
...
HopCoderX enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
