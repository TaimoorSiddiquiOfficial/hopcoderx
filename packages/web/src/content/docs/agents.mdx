...
The model ID in your HopCoderX config uses the format `provider/model-id`. For example, if you're using [HopCoderX Bdr](/docs/zen), you would use `HopCoderX/gpt-5.1-codex` for GPT 5.1 Codex.
