...
المعرّف الكامل هنا يكون بالشكل `provider_id/model_id`. على سبيل المثال، إذا كنت تستخدم [HopCoderX Bdr](/docs/bdr) فستستخدم `HopCoderX/gpt-5.1-codex` لنموذج GPT 5.1 Codex.
