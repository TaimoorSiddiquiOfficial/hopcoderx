...
اختبارها والتحقق من أنها تعمل بشكل جيد مع HopCoderX. [اعرف المزيد](/docs/zen).
...
تم ضبطه لاستخدام gpt-5-nano افتراضيا، مستضافا عبر Zen. لحصر HopCoderX
...
HopCoderX Bdr هي قائمة من النماذج التي تم اختبارها والتحقق منها مقدّمة من فريق HopCoderX. [اعرف المزيد](/docs/zen).
