...
HopCoderX Zen هي قائمة نماذج يوفّرها فريق HopCoderX وقد تم
اختبارها والتحقق من أنها تعمل بشكل جيد مع HopCoderX. [اعرف المزيد](/docs/zen).

:::tip
إذا كنت جديدا، فننصح بالبدء مع HopCoderX Zen.
:::

1. شغّل الأمر `/connect` في TUI، واختر HopCoderX، ثم انتقل إلى [HopCoderX.ai/auth](https://HopCoderX.ai/auth).
...
HopCoderX Zen هي قائمة من النماذج التي تم اختبارها والتحقق منها مقدّمة من فريق HopCoderX. [اعرف المزيد](/docs/zen).

1. سجّل الدخول إلى **<a href={console}>HopCoderX Zen</a>** وانقر **Create API Key**.

2. شغّل الأمر `/connect` وابحث عن **HopCoderX Zen**.
