---
title: خوادم LSP
description: يتكامل HopCoderX مع خوادم LSP لديك.
---

يتكامل HopCoderX مع بروتوكول خادم اللغة (LSP) لمساعدة LLM على التفاعل مع قاعدة الشيفرة لديك. ويستخدم التشخيصات لتزويد LLM بتغذية راجعة.

---

## المدمجة

يأتي HopCoderX مع عدة خوادم LSP مدمجة للغات الشائعة:
...
:::note
يمكنك تعطيل تنزيلات خوادم LSP التلقائية عبر ضبط متغير البيئة `HOPCODERX_DISABLE_LSP_DOWNLOAD` على `true`.
:::
...
عندما يفتح HopCoderX ملفا، فإنه:
...
يمكنك تخصيص خوادم LSP عبر قسم `lsp` في إعدادات HopCoderX.
