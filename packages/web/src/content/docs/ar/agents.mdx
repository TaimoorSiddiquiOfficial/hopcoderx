...
يستخدم معرّف النموذج في إعدادات HopCoderX الصيغة `provider/model-id`. على سبيل المثال، إذا كنت تستخدم [HopCoderX Bdr](/docs/zen)، فستستخدم `HopCoderX/gpt-5.1-codex` لـ GPT 5.1 Codex.
