...
يوجد نوعان من الوكلاء في HopCoderX: وكلاء أساسيون ووكلاء فرعيون.
...
يأتي HopCoderX مع وكيلين أساسيين مدمجين: **Build** و **Plan**. سنلقي نظرة عليهما أدناه.
...
يأتي HopCoderX مع وكيلين فرعيين مدمجين: **General** و **Explore**. سنلقي نظرة على ذلك أدناه.

---

## المدمجة

يأتي HopCoderX مع وكيلين أساسيين مدمجين ووكيلين فرعيين مدمجين.
...
هيّئ الوكلاء في ملف إعدادات `HopCoderX.json`:
...
- عام: `~/.config/HopCoderX/agents/`
- لكل مشروع: `.HopCoderX/agents/`
...
إذا لم يتم تحديد temperature، يستخدم HopCoderX القيم الافتراضية الخاصة بالنموذج؛ عادة 0 لمعظم النماذج و 0.55 لنماذج Qwen.
...
هذا المسار نسبي لمكان وجود ملف الإعدادات. لذلك يعمل هذا لكل من إعدادات HopCoderX العامة وإعدادات المشروع.
...
يستخدم معرّف النموذج في إعدادات HopCoderX الصيغة `provider/model-id`. على سبيل المثال، إذا كنت تستخدم [HopCoderX Bdr](/docs/bdr)، فستستخدم `HopCoderX/gpt-5.1-codex` لـ GPT 5.1 Codex.
...
:::tip
شغّل `HopCoderX models` لعرض قائمة بالنماذج المتاحة.
:::
...
:::tip
هل لديك وكيل تود مشاركته؟ [قدّم PR](https://github.com/TaimoorSiddiquiOfficial/hopcoderx).
:::
