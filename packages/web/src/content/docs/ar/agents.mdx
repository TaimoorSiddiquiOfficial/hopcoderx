...
يستخدم معرّف النموذج في إعدادات HopCoderX الصيغة `provider/model-id`. على سبيل المثال، إذا كنت تستخدم [HopCoderX Zen](/docs/zen)، فستستخدم `HopCoderX/gpt-5.1-codex` لـ GPT 5.1 Codex.
