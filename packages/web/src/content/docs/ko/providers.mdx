...
HopCoderX Zen은 HopCoderX 팀이 HopCoderX와 잘 작동하도록 테스트하고 검증한 모델 목록입니다. [더 알아보기](/docs/zen).

:::tip
처음이라면 HopCoderX Zen으로 시작하는 것이 좋습니다.
:::
...
HopCoderX Zen은 HopCoderX 팀에서 제공하는 테스트 및 검증된 모델 목록입니다. [더 알아보기](/docs/zen).

1. 로그인 **<a href={console}>HopCoderX Zen</a>** and click**Create API Key**.

2. `/connect` 명령을 실행하고 **HopCoderX Zen**를 검색하십시오.
