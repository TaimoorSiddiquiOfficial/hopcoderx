...
HopCoderX Zen is a list of models provided by the HopCoderX team that have been
tested and verified to work well with HopCoderX. [Learn more](/docs/zen).

:::tip
If you are new, we recommend starting with HopCoderX Zen.
:::

1. Run the `/connect` command in the TUI, select HopCoderX, and head to [HopCoderX.ai/auth](https://HopCoderX.ai/auth).
...
HopCoderX Zen is a list of tested and verified models provided by the HopCoderX team. [Learn more](/docs/zen).

1. Sign in to **<a href={console}>HopCoderX Zen</a>** and click **Create API Key**.

2. Run the `/connect` command and search for **HopCoderX Zen**.
