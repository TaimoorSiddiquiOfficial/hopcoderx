...
tested and verified to work well with HopCoderX. [Learn more](/docs/zen).
...
It is configured to use gpt-5-nano by default, hosted by Zen. To lock HopCoderX
...
HopCoderX Bdr is a list of tested and verified models provided by the HopCoderX team. [Learn more](/docs/zen).
