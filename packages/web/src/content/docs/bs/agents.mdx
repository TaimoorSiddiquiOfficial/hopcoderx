...
ID modela u vašoj HopCoderX konfiguraciji koristi format `provider/model-id`. Na primjer, ako koristite [HopCoderX Zen](/docs/zen), koristili biste `HopCoderX/gpt-5.1-codex` za GPT 5.1 Codex.
