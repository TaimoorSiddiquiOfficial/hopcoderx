---
title: TUI
description: Korištenje korisničkog interfejsa HopCoderX terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

HopCoderX pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje HopCoderX pokreće TUI za trenutni direktorij.
...
Kada koristite HopCoderX TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u HopCoderX. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz HopCoderX. _Aliases_: `/quit`, `/q`
...
Možete prilagoditi TUI ponašanje putem vašeg HopCoderX konfiguracionog fajla.
