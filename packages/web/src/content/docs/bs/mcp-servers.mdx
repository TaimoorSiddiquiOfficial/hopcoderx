...
Možete definirati MCP servere u vašoj [HopCoderX Config](https://HopCoderX.ai/docs/config/) pod `mcp`. Dodajte svaki MCP sa jedinstvenim imenom. Možete se pozvati na taj MCP po imenu kada tražite LLM.
