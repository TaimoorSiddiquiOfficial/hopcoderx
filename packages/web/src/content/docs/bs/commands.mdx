...
Kreiraj `.HopCoderX/commands/test.md`:
...
Možete dodati prilagođene komande kroz HopCoderX konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom HopCoderX [config](/docs/config):
...
- Globalno: `~/.config/HopCoderX/commands/`
- Po projektu: `.HopCoderX/commands/`
...
HopCoderX uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
