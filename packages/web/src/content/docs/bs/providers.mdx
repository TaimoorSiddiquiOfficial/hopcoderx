...
HopCoderX Zen je lista modela koje je obezbedio HopCoderX tim koji su bili
testirano i potvrđeno da dobro radi sa HopCoderX. [Saznajte više](/docs/zen).

:::tip
Ako ste novi, preporučujemo da počnete sa HopCoderX Zen.
:::

1. Pokrenite naredbu `/connect` u TUI-u, odaberite HopCoderX i idite na [HopCoderX.ai/auth](https://HopCoderX.ai/auth).
...
HopCoderX Zen je lista testiranih i verifikovanih modela koju je obezbedio HopCoderX tim. [Saznajte više](/docs/zen).

1. Prijavite se na **<a href={console}>HopCoderX Zen</a>** i kliknite na **Kreiraj API ključ**.

2. Pokrenite naredbu `/connect` i potražite **HopCoderX Zen**.
