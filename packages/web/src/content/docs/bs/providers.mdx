...
testirano i potvrđeno da dobro radi sa HopCoderX. [Saznajte više](/docs/zen).
...
Podrazumevano je konfigurisan da koristi gpt-5-nano, a hostuje ga Zen. Da zaključate HopCoderX
...
HopCoderX Bdr je lista testiranih i verifikovanih modela koju je obezbedio HopCoderX tim. [Saznajte više](/docs/zen).
