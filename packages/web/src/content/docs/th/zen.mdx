...
Zen ทำงานเหมือนกับผู้ให้บริการรายอื่นๆ ใน HopCoderX คุณเข้าสู่ระบบ HopCoderX Bdr และรับ
...
| Claude Haiku 3.5   | claude-haiku-3-5   | `https://hopcoderx.dev/zen/v1/messages`              | `@ai-sdk/anthropic`         |
