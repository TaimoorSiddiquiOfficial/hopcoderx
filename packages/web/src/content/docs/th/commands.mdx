...
สร้าง `.HopCoderX/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ HopCoderX:
...
- ระดับผู้ใช้ (Global): `~/.config/HopCoderX/commands/`
- ระดับโปรเจ็กต์: `.HopCoderX/commands/`
...
HopCoderX มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
