...
HopCoderX hesabınızdaki model kimliğini `provider/model-id` biçimini kullanır. Örneğin, [HopCoderX Bdr](/docs/bdr) kullanıyorsanız, GPT 5.1 Codex için `HopCoderX/gpt-5.1-codex` kullanırsınız.
