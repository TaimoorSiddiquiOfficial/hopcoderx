...
HopCoderX Zen, HopCoderX ekibi tarafından sağlanan modellerin bir listesidir.
HopCoderX ile iyi çalıştığı test edilip doğrulandı. [Daha fazla bilgi](/docs/zen).

:::tip
Yeniyseniz HopCoderX Zen ile başlamanızı öneririz.
:::

1. TUI'de `/connect` komutunu çalıştırın, HopCoderX'u seçin ve [HopCoderX.ai/auth](https://HopCoderX.ai/auth)'ye gidin.
...
HopCoderX Zen, HopCoderX ekibinin test edip doğruladığı modellerin bir listesidir. [Daha fazla bilgi](/docs/zen).

1. **<a href={console}>HopCoderX Zen</a>**'de oturum açın ve **API Anahtarı Oluştur**'u tıklayın.

2. `/connect` komutunu çalıştırın ve **HopCoderX Zen**'i arayın.
