...
HopCoderX ile iyi çalıştığı test edilip doğrulandı. [Daha fazla bilgi](/docs/bdr).
...
Varsayılan olarak Bdr tarafından barındırılan gpt-5-nano'yu kullanacak şekilde yapılandırılmıştır. HopCoderX'u kilitlemek için
...
HopCoderX Bdr, HopCoderX ekibinin test edip doğruladığı modellerin bir listesidir. [Daha fazla bilgi](/docs/bdr).
