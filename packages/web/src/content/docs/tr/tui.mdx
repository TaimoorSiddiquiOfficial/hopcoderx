---
title: TUI
description: HopCoderX terminal arayuzunu kullanin.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

HopCoderX, projelerinizde LLM ile calismak icin etkilesimli bir terminal arayuzu (TUI) sunar.

HopCoderX'u calistirdiginizda mevcut dizin icin TUI baslar.
...
HopCoderX TUI kullanirken `/` ve komut adini yazarak hizli eylemler calistirabilirsiniz. Ornek:
...
HopCoderX'a bir provider ekler. Mevcut provider'lari secip API anahtarlari eklemenizi saglar.
...
HopCoderX'dan cikar. _Takma adlar_: `/quit`, `/q`
...
TUI davranisini HopCoderX config dosyanizdan ozellestirebilirsiniz.
