...
description: HopCoderX dile özgü biçimlendiriciler kullanır.
---

HopCoderX, dosyaları dile özgü formatlayıcılar kullanılarak yazıldıktan veya düzenlendikten sonra otomatik olarak formatlar. Bu, oluşturulan kodun projenizin kod stillerine uymasını sağlar.

---

## Yerleşik

HopCoderX, popüler diller ve çerçeveler için çeşitli yerleşik biçimlendiricilerle birlikte gelir. Aşağıda ihtiyaç duyduğu biçimlendiricilerin, desteklenen dosya uzantılarının ve komutların veya yapılandırma seçeneklerinin bir listesi bulunmaktadır.
...
Yani eğer projenizin `package.json` dosyasında `prettier` varsa, HopCoderX bunu otomatik olarak kullanacaktır.

---

## Nasıl çalışır?

HopCoderX bir dosyayı yazdığında veya düzenlediğinde:
...
Biçimlendiricileri HopCoderX yapılandırmanızdaki `formatter` bölümü aracılığıyla özelleştirebilirsiniz.
