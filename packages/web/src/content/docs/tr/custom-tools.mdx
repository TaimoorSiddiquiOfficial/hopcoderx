---
title: Özel Araçlar
description: LLM'un HopCoderX'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. HopCoderX'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.HopCoderX/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/HopCoderX/tools/` içine yerleştirerek.
