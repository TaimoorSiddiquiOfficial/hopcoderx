...
`.HopCoderX/commands/test.md` oluştur:
...
HopCoderX işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

HopCoderX [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.config/HopCoderX/commands/`
- Proje başına: `.HopCoderX/commands/`
...
HopCoderX, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).
