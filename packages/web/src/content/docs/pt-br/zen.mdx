...
O HopCoderX Zen é uma lista de modelos testados e verificados fornecidos pela equipe do HopCoderX.

:::note
O HopCoderX Zen está atualmente em beta.
:::

O Zen funciona como qualquer outro provedor no HopCoderX. Você faz login no HopCoderX Zen e obtém sua chave de API. É **completamente opcional** e você não precisa usá-lo para utilizar o HopCoderX.
...
O HopCoderX Zen é um gateway de IA que lhe dá acesso a esses modelos.

---

## Como funciona

O HopCoderX Zen funciona como qualquer outro provedor no HopCoderX.

1. Você faz login no **<a href={console}>HopCoderX Zen</a>**, adiciona seus dados de cobrança e copia sua chave de API.
2. Você executa o comando `/connect` no TUI, seleciona HopCoderX Zen e cola sua chave de API.
