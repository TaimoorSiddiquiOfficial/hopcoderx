...
O Zen funciona como qualquer outro provedor no HopCoderX. Você faz login no HopCoderX Bdr e obtém sua chave de API. É **completamente opcional** e você não precisa usá-lo para utilizar o HopCoderX.
