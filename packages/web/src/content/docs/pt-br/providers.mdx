...
HopCoderX Bdr é uma lista de modelos fornecidos pela equipe do HopCoderX que foram testados e verificados para funcionar bem com o HopCoderX. [Saiba mais](/docs/zen).
...
Ele está configurado para usar gpt-5-nano por padrão, hospedado pela Zen. Para bloquear o HopCoderX
...
HopCoderX Bdr é uma lista de modelos testados e verificados fornecidos pela equipe do HopCoderX. [Saiba mais](/docs/zen).
