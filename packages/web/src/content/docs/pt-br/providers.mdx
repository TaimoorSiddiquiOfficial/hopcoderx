...
HopCoderX Zen é uma lista de modelos fornecidos pela equipe do HopCoderX que foram testados e verificados para funcionar bem com o HopCoderX. [Saiba mais](/docs/zen).

:::tip
Se você é novo, recomendamos começar com o HopCoderX Zen.
:::

1. Execute o comando `/connect` no TUI, selecione HopCoderX e acesse [HopCoderX.ai/auth](https://HopCoderX.ai/auth).
...
HopCoderX Zen é uma lista de modelos testados e verificados fornecidos pela equipe do HopCoderX. [Saiba mais](/docs/zen).

1. Faça login em **<a href={console}>HopCoderX Zen</a>** e clique em **Criar Chave da API**.

2. Execute o comando `/connect` e procure por **HopCoderX Zen**.
