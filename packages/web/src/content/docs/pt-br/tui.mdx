---
title: TUI
description: Usando a interface de usuário de terminal HopCoderX.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

O HopCoderX fornece uma interface de terminal interativa ou TUI para trabalhar em seus projetos com um LLM.

Executar HopCoderX inicia o TUI para o diretório atual.
...
Ao usar o TUI do HopCoderX, você pode digitar `/` seguido pelo nome de um comando para executar ações rapidamente. Por exemplo:
...
Adicione um provedor ao HopCoderX. Permite que você selecione entre os provedores disponíveis e adicione suas chaves de API.
...
Saia do HopCoderX. _Aliases_: `/quit`, `/q`
...
Você pode personalizar o comportamento do TUI através do seu arquivo de configuração do HopCoderX.
