...
Aqui, o ID completo é `provider_id/model_id`. Por exemplo, se você estiver usando [HopCoderX Bdr](/docs/zen), você usaria `HopCoderX/gpt-5.1-codex` para GPT 5.1 Codex.
