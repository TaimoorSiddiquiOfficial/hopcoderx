...
O ID do modelo em sua configuração do HopCoderX usa o formato `provider/model-id`. Por exemplo, se você estiver usando [HopCoderX Bdr](/docs/bdr), você usaria `HopCoderX/gpt-5.1-codex` para GPT 5.1 Codex.
