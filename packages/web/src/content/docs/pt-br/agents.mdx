...
O ID do modelo em sua configuração do HopCoderX usa o formato `provider/model-id`. Por exemplo, se você estiver usando [HopCoderX Zen](/docs/zen), você usaria `HopCoderX/gpt-5.1-codex` para GPT 5.1 Codex.
