---
title: TUI
description: Utilisation de l’interface utilisateur du terminal HopCoderX.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

HopCoderX fournit une interface de terminal interactif ou TUI pour travailler sur vos projets avec un LLM.

L’exécution de HopCoderX démarre le TUI pour le répertoire actuel.
...
Lorsque vous utilisez le HopCoderX TUI, vous pouvez taper `/` suivi d'un nom de commande pour exécuter rapidement des actions. Par exemple:
...
Ajoutez un fournisseur à HopCoderX. Vous permet de sélectionner parmi les fournisseurs disponibles et d’ajouter leurs clés API.
...
Quittez HopCoderX. *Alias* : `/quit`, `/q`
...
Vous pouvez personnaliser le comportement de TUI via votre fichier de configuration HopCoderX.
