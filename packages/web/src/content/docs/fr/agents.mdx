...
L'ID de modèle dans votre configuration HopCoderX utilise le format `provider/model-id`. Par exemple, si vous utilisez [HopCoderX Zen](/docs/zen), vous utiliserez `HopCoderX/gpt-5.1-codex` pour GPT 5.1 Codex.
