...
testé et vérifié pour fonctionner correctement avec HopCoderX. [En savoir plus](/docs/bdr).
...
Il est configuré pour utiliser gpt-5-nano par défaut, hébergé par Bdr. Pour verrouiller HopCoderX
...
HopCoderX Bdr est une liste de modèles testés et vérifiés fournie par l'équipe HopCoderX. [En savoir plus](/docs/bdr).
