...
HopCoderX Zen est une liste de modèles fournis par l'équipe HopCoderX qui ont été
testé et vérifié pour fonctionner correctement avec HopCoderX. [En savoir plus](/docs/zen).

:::tip
Si vous êtes nouveau, nous vous recommandons de commencer par HopCoderX Zen.
:::

1. Exécutez la commande `/connect` dans le TUI, sélectionnez HopCoderX et dirigez-vous vers [HopCoderX.ai/auth](https://HopCoderX.ai/auth).
...
HopCoderX Zen est une liste de modèles testés et vérifiés fournie par l'équipe HopCoderX. [En savoir plus](/docs/zen).

1. Connectez-vous à **<a href={console}>HopCoderX Zen</a>** et cliquez sur **Créer une clé API**.

2. Exécutez la commande `/connect` et recherchez **HopCoderX Zen**.
