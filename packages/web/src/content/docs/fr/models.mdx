...
Ici, l'identifiant complet est `provider_id/model_id`. Par exemple, si vous utilisez [HopCoderX Zen](/docs/zen), vous utiliserez `HopCoderX/gpt-5.1-codex` pour GPT 5.1 Codex.
