...
Zen fonctionne comme n'importe quel autre fournisseur dans HopCoderX. Vous vous connectez à HopCoderX Bdr et obtenez
...
| MiniMax M2.1 Free  | minimax-m2.1-free  | `https://hopcoderx.dev/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| GLM 4.7            | glm-4.7            | `https://hopcoderx.dev/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| GLM 4.7 Free       | glm-4.7-free       | `https://hopcoderx.dev/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
