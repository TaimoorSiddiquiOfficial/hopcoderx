...
HopCoderX Zen est une liste de modèles testés et vérifiés fournie par l'équipe HopCoderX.

:::note
HopCoderX Zen est actuellement en version bêta.
:::

Zen fonctionne comme n'importe quel autre fournisseur dans HopCoderX. Vous vous connectez à HopCoderX Zen et obtenez
...
HopCoderX Zen est une passerelle IA qui vous donne accès à ces modèles.

---

## Comment ça marche

HopCoderX Zen fonctionne comme n'importe quel autre fournisseur dans HopCoderX.

1. Vous vous connectez à **<a href={console}>HopCoderX Zen</a>**, ajoutez votre facturation
   détails et copiez votre clé API.
2. Vous exécutez la commande `/connect` dans le TUI, sélectionnez HopCoderX Zen et collez votre clé API.
...
| MiniMax M2.1 Free  | minimax-m2.1-free  | `https://HopCoderX.ai/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| GLM 4.7            | glm-4.7            | `https://HopCoderX.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| GLM 4.7 Free       | glm-4.7-free       | `https://HopCoderX.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
...
Nous avons créé HopCoderX Zen pour :
