...
протестировано и проверено на хорошую работу с HopCoderX. [Подробнее](/docs/bdr).
...
По умолчанию он настроен на использование gpt-5-nano, размещенного на Bdr. Чтобы заблокировать HopCoderX
...
HopCoderX Bdr — это список протестированных и проверенных моделей, предоставленный командой HopCoderX. [Подробнее](/docs/bdr).
