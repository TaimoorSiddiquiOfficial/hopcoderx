...
HopCoderX Zen — это список моделей, предоставленный командой HopCoderX, которые были
протестировано и проверено на хорошую работу с HopCoderX. [Подробнее](/docs/zen).

:::tip
Если вы новичок, мы рекомендуем начать с HopCoderX Zen.
:::

1. Запустите команду `/connect` в TUI, выберите HopCoderX и перейдите по адресу [HopCoderX.ai/auth](https://HopCoderX.ai/auth).
...
HopCoderX Zen — это список протестированных и проверенных моделей, предоставленный командой HopCoderX. [Подробнее](/docs/zen).

1. Войдите в систему **<a href={console}>HopCoderX Zen</a>** и нажмите **Создать ключ API**.

2. Запустите команду `/connect` и найдите **HopCoderX Zen**.
