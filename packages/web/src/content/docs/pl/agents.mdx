...
Identyfikator modelu jest taki sam, jak w konfiguracji HopCoderX w `provider/model-id`. Na przykład, [HopCoderX Zen](/docs/zen), użyj `HopCoderX/gpt-5.1-codex` dla GPT 5.1 Codex.
