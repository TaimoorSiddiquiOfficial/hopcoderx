...
Tutaj pełny identyfikator do `provider_id/model_id`. Na przykład, użycie [HopCoderX Bdr](/docs/zen), przestrzeganie `HopCoderX/gpt-5.1-codex` dla Kodeksu GPT 5.1.
