---
title: Udostępnianie
description: Udostępnij swoje rozmowy dotyczące HopCoderX.
---

Funkcja udostępniania HopCoderX umożliwia tworzenie publicznych linków do konwersacji HopCoderX, dzięki czemu możesz współpracować z członkami zespołu lub uzyskać pomoc od innych.
...
Kiedy udostępniasz rozmowę, HopCoderX:
...
HopCoderX obsługuje trzy tryby udostępniania, które kontrolują sposób udostępniania rozmów:

---

### Ręczne (domyślne)

Domyślnie HopCoderX korzysta z ręcznego trybu udostępniania. Sesje nie są udostępniane automatycznie, ale możesz je udostępnić ręcznie za pomocą polecenia `/share`:
...
Aby wymusić to w całym zespole dla danego projektu, dodaj go do `HopCoderX.json` w swoim projekcie i sprawdź w Git.
...
[Dowiedz się więcej](/docs/enterprise) o używaniu HopCoderX w Twojej organizacji.
