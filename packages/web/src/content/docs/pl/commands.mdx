...
Utwórz `.HopCoderX/commands/test.md`:
...
Możesz zdefiniować polecenia w `HopCoderX.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji HopCoderX:
...
- Globalnie: `~/.config/HopCoderX/commands/`
- Na projekt: `.HopCoderX/commands/`
...
HopCoderX zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
