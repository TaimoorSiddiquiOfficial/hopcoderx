...
przetestowane i zweryfikowane, aby dobrze współpracować z HopCoderX. [Dowiedz się więcej](/docs/bdr).
...
Domyślnie jest skonfigurowany do używania gpt-5-nano, hostowanego przez Bdr. Aby zablokować HopCoderX
...
HopCoderX Bdr to lista przetestowanych i zweryfikowanych modeli udostępniona przez zespół HopCoderX. [Dowiedz się więcej](/docs/bdr).
