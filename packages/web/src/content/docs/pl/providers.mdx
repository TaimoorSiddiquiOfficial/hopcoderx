...
HopCoderX Zen to lista modeli dostarczonych przez zespół HopCoderX, które zostały
przetestowane i zweryfikowane, aby dobrze współpracować z HopCoderX. [Dowiedz się więcej](/docs/zen).

:::tip
Jeśli jesteś nowy, zalecamy rozpoczęcie od HopCoderX Zen.
:::
...
HopCoderX Zen to lista przetestowanych i zweryfikowanych modeli udostępniona przez zespół HopCoderX. [Dowiedz się więcej](/docs/zen).

1. Zaloguj się do **<a href={console}>HopCoderX Zen</a>** i kliknij **Utwórz klucz API**.

2. Uruchom polecenie `/connect` i wyszukaj **HopCoderX Zen**.
