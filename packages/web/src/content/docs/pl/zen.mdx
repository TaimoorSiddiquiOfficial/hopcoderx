...
HopCoderX Zen to lista przetestowanych i zweryfikowanych modeli udostępniona przez zespół HopCoderX.

:::note
HopCoderX Zen is currently in beta.
:::

Zen działa jak każdy inny dostawca HopCoderX. Logujesz się do HopCoderX Zen i dostajesz
...
HopCoderX Zen to brama AI, która zapewnia dostęp do tych modeli.

---

## Jak to działa

HopCoderX Zen działa jak każdy inny dostawca HopCoderX.

1. Logujesz się do **<a href={console}>HopCoderX Zen</a>**, dodajesz swoje rozliczenia
   szczegóły i skopiuj klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz HopCoderX Zen i wklejasz klucz API.
...
Stworzyliśmy HopCoderX Zen, aby:
