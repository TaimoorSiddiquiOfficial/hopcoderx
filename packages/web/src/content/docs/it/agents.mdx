...
L'ID modello nella configurazione HopCoderX usa il formato `provider/model-id`. Per esempio, se stai usando [HopCoderX Zen](/docs/zen), useresti `HopCoderX/gpt-5.1-codex` per GPT 5.1 Codex.
