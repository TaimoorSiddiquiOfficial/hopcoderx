...
HopCoderX Zen e una lista di modelli forniti dal team HopCoderX, testati e
verificati per funzionare bene con HopCoderX. [Scopri di piu](/docs/zen).

:::tip
Se sei all'inizio, ti consigliamo di partire da HopCoderX Zen.
:::

1. Esegui `/connect` nella TUI, seleziona HopCoderX e vai su [HopCoderX.ai/auth](https://HopCoderX.ai/auth).
...
HopCoderX Zen è una lista di modelli testati e verificati forniti dal team HopCoderX. [Scopri di più](/docs/zen).

1. Accedi a **<a href={console}>HopCoderX Zen</a>** e clicca **Create API Key**.

2. Esegui il comando `/connect` e cerca **HopCoderX Zen**.
