...
HopCoderX Zen e una lista di modelli testati e verificati dal team di HopCoderX.

:::note
HopCoderX Zen e attualmente in beta.
:::

Zen funziona come qualunque altro provider in HopCoderX. Accedi a HopCoderX Zen e ottieni la tua chiave API. E **completamente opzionale**: non devi usarlo per usare HopCoderX.
...
HopCoderX Zen e un gateway AI che ti da accesso a questi modelli.

---

## Come funziona

HopCoderX Zen funziona come qualunque altro provider in HopCoderX.

1. Accedi a **<a href={console}>HopCoderX Zen</a>**, aggiungi i dettagli di fatturazione e copia la chiave API.
2. Esegui il comando `/connect` nella TUI, seleziona HopCoderX Zen e incolla la chiave API.
...
Abbiamo creato HopCoderX Zen per:
