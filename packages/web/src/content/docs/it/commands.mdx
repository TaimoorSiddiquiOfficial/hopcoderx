...
Crea `.HopCoderX/commands/test.md`:
...
Puoi aggiungere comandi personalizzati tramite la config di HopCoderX o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di HopCoderX:
...
- Globale: `~/.config/HopCoderX/commands/`
- Per progetto: `.HopCoderX/commands/`
...
HopCoderX include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
