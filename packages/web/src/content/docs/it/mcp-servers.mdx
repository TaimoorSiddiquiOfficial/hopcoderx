...
Puoi definire server MCP nella tua [HopCoderX Config](https://HopCoderX.ai/docs/config/) sotto `mcp`. Aggiungi ogni MCP con un nome univoco. Puoi riferirti a quell'MCP per nome quando fai prompt all'LLM.
