...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders HOPCODERX_CALLER", () => {
    process.env["HOPCODERX_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode HOPCODERX_CALLER", () => {
    process.env["HOPCODERX_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown HOPCODERX_CALLER", () => {
    process.env["HOPCODERX_CALLER"] = "unknown"
