...
import type { AssistantMessage, Event, HopCoderXClient, SessionMessageResponse } from "@hopcoderx/sdk/v2"
...
export namespace ACP {
  ...
  export async function init({ sdk: _sdk }: { sdk: HopCoderXClient }) {
    return {
