...
**⚠️ CRITICAL: Never review PRs in HopCoderX's own project folder!**
...
8. **NEVER start Codex inside your HopCoderX state directory** (`$HopCoderX_STATE_DIR`, default `~/.HopCoderX`) - it'll read your soul docs and get weird ideas about the org chart!
9. **NEVER checkout branches in ~/Projects/HopCoderX/** - that's the LIVE HopCoderX instance!
...
For long-running background tasks, append a wake trigger to your prompt so HopCoderX gets notified immediately when the agent finishes (instead of waiting for the next heartbeat):

```
... your task here.

When completely finished, run this command to notify me:
HopCoderX system event --text "Done: [brief summary of what was built]" --mode now
```
...
When completely finished, run: HopCoderX system event --text \"Done: Built todos REST API with CRUD endpoints\" --mode now'"
```
