...
export namespace HubBundles {
  export const registry: HubManifest.Bundle[] = [
    ...
    HubManifest.Bundle.parse({
      id: "bundle:data-analysis",
      kind: "bundle",
      name: "Data Analysis",
      description: "SQL querying, data exploration, and analytical reasoning tools for data-heavy workflows.",
      source: "builtin",
      category: "data",
      tags: ["data", "sql", "analytics", "exploration", "duckdb"],
      author: "HopCoderX",
      recommendedAgent: "explore",
      aliases: ["data", "analytics"],
      starterPrompts: [
        "Explore this dataset: describe the schema, surface anomalies, and propose key aggregations.",
        "Write and explain SQL queries to answer these analytical questions about the data.",
      ],
      activation: {
        defaultEnabled: false,
        autoDisableWhenMissing: false,
      ...
      items: [
        { kind: "mcp", id: "mcp:postgres", reason: "Query production or staging databases directly" },
        { kind: "mcp", id: "mcp:sqlite", reason: "Explore local SQLite databases and CSV-imported data" },
        { kind: "mcp", id: "mcp:sequential-thinking", reason: "Structured analytical reasoning and hypothesis testing" },
        { kind: "mcp", id: "mcp:memory", reason: "Retain findings and query results across analysis sessions" },
      ],
    }),
    HubManifest.Bundle.parse({
      id: "bundle:security-audit",
      kind: "bundle",
      name: "Security Audit",
      description: "Dependency scanning, secret detection, and structured vulnerability analysis stack.",
      source: "builtin",
      category: "security",
      tags: ["security", "audit", "vulnerabilities", "secrets", "dependencies"],
      author: "HopCoderX",
      recommendedAgent: "reviewer",
      aliases: ["security", "vuln-scan"],
      starterPrompts: [
        "Audit this codebase for hardcoded secrets, insecure dependencies, and common vulnerability patterns.",
        "Scan the dependency manifest for known CVEs and summarize the highest-risk findings with remediation steps.",
      ],
      activation: {
        defaultEnabled: false,
        autoDisableWhenMissing: false,
      ...
      items: [
        { kind: "skill", id: "skill:builtin:github", reason: "Access repository files and pull security context" },
        { kind: "mcp", id: "mcp:github", reason: "Read dependency files, security advisories, and code scanning alerts" },
        { kind: "mcp", id: "mcp:sequential-thinking", reason: "Structured threat modeling and risk ranking" },
        { kind: "mcp", id: "mcp:memory", reason: "Track audit findings and remediation progress across sessions" },
      ],
    }),
    HubManifest.Bundle.parse({
      id: "bundle:design-to-code",
      kind: "bundle",
      name: "Design to Code",
      description: "Design system inspection, Figma handoff, and browser-verified UI implementation stack.",
      source: "builtin",
      category: "design",
      tags: ["design", "figma", "ui", "components", "frontend"],
      author: "HopCoderX",
      recommendedAgent: "build",
      aliases: ["design", "figma-to-code"],
      starterPrompts: [
        "Inspect this design and implement the component using the existing design system tokens and patterns.",
        "Compare the current implementation to the design spec and list visual discrepancies with fix suggestions.",
      ],
      activation: {
        defaultEnabled: false,
        autoDisableWhenMissing: false,
      ...
      items: [
        { kind: "mcp", id: "mcp:figma", reason: "Read design tokens, component specs, and layout constraints" },
        { kind: "mcp", id: "mcp:playwright", reason: "Render and visually verify implemented components in the browser" },
        { kind: "mcp", id: "mcp:npm-mcp", reason: "Manage design system and component library dependencies" },
        { kind: "mcp", id: "mcp:sequential-thinking", reason: "Systematic design-to-implementation translation" },
      ],
    }),
  ]
