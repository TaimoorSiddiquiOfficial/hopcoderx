...
const STORAGE_KEYS = {
  THEME_ID: "HopCoderX-theme-id",
  COLOR_SCHEME: "HopCoderX-color-scheme",
  THEME_CSS_LIGHT: "HopCoderX-theme-css-light",
  THEME_CSS_DARK: "HopCoderX-theme-css-dark",
} as const
...
export const { use: useTheme, provider: ThemeProvider } = createSimpleContext({
  ...
  init: (props: { defaultTheme?: string }) => {
    const [store, setStore] = createStore({
      ...
      themeId: props.defaultTheme ?? "hopcoderx",
